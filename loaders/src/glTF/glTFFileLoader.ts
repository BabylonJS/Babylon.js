...
export class GLTFFileLoader implements IDisposable, ISceneLoaderPluginAsync, ISceneLoaderPluginFactory {
    ...
    */
    ...
    public directLoad(scene: Scene, data: string): Promise<any> {
        if (StringTools.StartsWith(data, "application/octet-stream;base64," + GLTFFileLoader.magicBase64Encoded) ||
            StringTools.StartsWith(data, "model/gltf-binary;base64," + GLTFFileLoader.magicBase64Encoded)) {
            const arrayBuffer = StringTools.DecodeBase64ToBinary(data);
