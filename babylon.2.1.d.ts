    ...
    */
    class Engine {
        ...
        */
        ...
        public setState(culling: boolean, zOffset?: number, force?: boolean): void;
    ...
    */
    class Scene {
        ...
        */
        ...
        public dumpNextRenderTargets: boolean;
        ...
        */
        ...
        public addMesh(newMesh: AbstractMesh): void;
        ...
        */
        ...
        public createDefaultCameraOrLight(): void;
...
declare module BABYLON {
    class Analyser {
        ...
        public DEBUGCANVASPOS: {
            x: number;
            y: number;
        };
        public DEBUGCANVASSIZE: {
            width: number;
            height: number;
        };
        private _byteFreqs;
...
declare module BABYLON {
    class AudioEngine {
        ...
        public WarnedWebAudioUnsupported: boolean;
        constructor();
        public dispose(): void;
...
declare module BABYLON {
    class Camera extends Node {
        ...
        public _activeMeshes: SmartArray<Mesh>;
        private _globalPosition;
        constructor(name: string, position: Vector3, scene: Scene);
        public globalPosition : Vector3;
        public getActiveMeshes(): SmartArray<Mesh>;
        public isActiveMesh(mesh: Mesh): boolean;
        public _initCache(): void;
        public _updateCache(ignoreParentClass?: boolean): void;
...
declare module BABYLON {
    ...
    class PickingInfo {
        ...
        public faceId: number;
        public subMeshId: number;
        public getNormal(useWorldCoordinates?: boolean): Vector3;
...
declare module BABYLON {
    class DebugLayer {
        ...
        public hide(): void;
        public show(showUI?: boolean, camera?: Camera): void;
...
declare module BABYLON {
    class DirectionalLight extends Light implements IShadowLight {
        ...
        private _worldMatrix;
        public shadowOrthoScale: number;
        constructor(name: string, direction: Vector3, scene: Scene);
        public getAbsolutePosition(): Vector3;
        public setDirectionToTarget(target: Vector3): Vector3;
        public setShadowProjectionMatrix(matrix: Matrix, viewMatrix: Matrix, renderList: AbstractMesh[]): void;
...
declare module BABYLON {
    ...
    class Light extends Node {
        ...
        public range: number;
        public includeOnlyWithLayerMask: number;
...
declare module BABYLON {
    ...
    class Color4 {
        ...
        public addInPlace(right: any): Color4;
        public asArray(): number[];
    ...
    class Vector2 {
        ...
        public toString(): string;
        public toArray(array: number[], index?: number): Vector2;
        public asArray(): number[];
    ...
    class Vector3 {
        ...
        public toString(): string;
        public asArray(): number[];
        public toArray(array: number[], index?: number): Vector3;
    ...
    class Matrix {
        ...
        public copyToArray(array: Float32Array, offset?: number): Matrix;
        ...
        public multiplyToArraySIMD(other: Matrix, result: Matrix, offset?: number): void;
    ...
    class PathCursor {
        ...
        public moveAhead(step?: number): PathCursor;
        public moveBack(step?: number): PathCursor;
...
declare module BABYLON {
    ...
    class Mesh extends AbstractMesh implements IGetSetVerticesData {
        ...
        */
        ...
        public updateMeshPositions(positionFunction: any): void;
        ...
        public _processRendering(subMesh: SubMesh, effect: Effect, fillMode: number, batch: _InstancesBatch, hardwareInstancedRendering: boolean, onBeforeDraw: (isInstance: boolean, world: Matrix) => void): void;
        ...
        */
        public simplify(settings: ISimplificationSettings[], parallelProcessing?: boolean, simplificationType?: SimplificationType, successCallback?: (mesh?: Mesh, submeshIndex?: number) => void): void;
        /**
        ...
        */
        public optimizeIndices(successCallback?: (mesh?: Mesh) => void): void;
        ...
        static ExtrudeShape(name: string, shape: Vector3[], path: Vector3[], scale: number, rotation: number, scene: Scene, updatable?: boolean, sideOrientation?: number): Mesh;
        static ExtrudeShapeCustom(name: string, shape: Vector3[], path: Vector3[], scaleFunction: any, rotationFunction: any, ribbonCloseArray: boolean, ribbonClosePath: boolean, scene: Scene, updatable?: boolean, sideOrientation?: number): Mesh;
        private static _ExtrudeShapeGeneric(name, shape, curve, scale, rotation, scaleFunction, rotateFunction, rbCA, rbCP, custom, scene, updtbl, side);
        ...
        static CreateTube(name: string, path: Vector3[], radius: number, tesselation: number, radiusFunction: (i: number, distance: number) => number, scene: Scene, updatable?: boolean, sideOrientation?: number): Mesh;
...
declare module BABYLON {
    ...
    */
    ...
    class SimplificationQueue {
        ...
        public running: any;
        constructor();
        public addTask(task: ISimplificationTask): void;
        public executeNext(): void;
        public runSimplification(task: ISimplificationTask): void;
    ...
    */
    ...
    class DecimationTriangle {
        public vertices: DecimationVertex[];
        public normal: Vector3;
        public error: number[];
    ...
    */
    class QuadraticErrorSimplification implements ISimplifier {
        ...
        public simplify(settings: ISimplificationSettings, successCallback: (simplifiedMesh: Mesh) => void): void;
...
declare module BABYLON {
    class LensRenderingPipeline extends PostProcessRenderPipeline {
        ...
        * @type {string}
        */
        public LensChromaticAberrationEffect: string;
        /**
        * The highlights enhancing PostProcess id in the pipeline
        * @type {string}
        */
        public HighlightsEnhancingEffect: string;
        /**
        * The depth-of-field PostProcess id in the pipeline
        * @type {string}
        */
        public LensDepthOfFieldEffect: string;
        private _scene;
        ...
        */
        ...
        public setEdgeBlur(amount: number): void;
        public disableEdgeBlur(): void;
        public setGrainAmount(amount: number): void;
        public disableGrain(): void;
        public setChromaticAberration(amount: number): void;
        public disableChromaticAberration(): void;
        public setEdgeDistortion(amount: number): void;
        public disableEdgeDistortion(): void;
        public setFocusDepth(amount: number): void;
        public disableDepthOfField(): void;
        public setAperture(amount: number): void;
        public enablePentagonBokeh(): void;
        public disablePentagonBokeh(): void;
        public enableNoiseBlur(): void;
        public disableNoiseBlur(): void;
        public setHighlightsGain(amount: number): void;
        public setHighlightsThreshold(amount: number): void;
        public disableHighlights(): void;
        /**
        * Removes the internal pipeline assets and detaches the pipeline from the scene cameras
        */
        public dispose(disableDepthRender?: boolean): void;
...
declare module BABYLON {
    class SSAORenderingPipeline extends PostProcessRenderPipeline {
        ...
        * @type {string}
        */
        public SSAOOriginalSceneColorEffect: string;
        /**
        * The SSAO PostProcess id in the pipeline
        * @type {string}
        */
        public SSAORenderEffect: string;
        /**
        * The horizontal blur PostProcess id in the pipeline
        * @type {string}
        */
        public SSAOBlurHRenderEffect: string;
        /**
        * The vertical blur PostProcess id in the pipeline
        * @type {string}
        */
        public SSAOBlurVRenderEffect: string;
        /**
        * The PostProcess id in the pipeline that combines the SSAO-Blur output with the original scene color (SSAOOriginalSceneColorEffect)
        * @type {string}
        */
        public SSAOCombineRenderEffect: string;
        /**
...
declare module BABYLON {
    class VolumetricLightScatteringPostProcess extends PostProcess {
        ...
        * @type {boolean}
        */
        public useCustomMeshPosition: boolean;
        /**
...
declare module BABYLON {
    class SmartCollection {
        ...
        public empty(): void;
        public forEach(block: (item: any) => void): void;
    }
}
...
declare module BABYLON {
    class RenderTargetTexture extends Texture {
        ...
        public render(useCameraPostProcess?: boolean, dumpForDebug?: boolean): void;
