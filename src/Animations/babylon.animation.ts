namespace BABYLON {
  ...
  export class Animation {
    ...
    public static CreateAndStartAnimation(
      ...
      var animation = Animation._PrepareAnimation(
        name,
        targetProperty,
        framePerSecond,
        totalFrame,
    ...
    public static TransitionTo(
      ...
      var animation: Animatable = scene.beginAnimation(
        host,
        0,
        endFrame,
        false
    ...
    constructor(
      ...
      this.loopMode =
        loopMode === undefined ? Animation.ANIMATIONLOOPMODE_CYCLE : loopMode;
    }
    ...
    public toString(fullDetails?: boolean): string {
      ...
      ret +=
        ", datatype: " +
        ["Float", "Vector3", "Quaternion", "Matrix", "Color3", "Vector2"][
          this.dataType
        ];
    ...
    public floatInterpolateFunction(
      startValue: number,
      endValue: number,
      gradient: number
    ): number {
    ...
    public floatInterpolateFunctionWithTangents(
      startValue: number,
      outTangent: number,
      endValue: number,
      inTangent: number,
    ...
    public quaternionInterpolateFunction(
    ...
    public quaternionInterpolateFunctionWithTangents(
      startValue: Quaternion,
    ...
    public vector3InterpolateFunction(
      startValue: Vector3,
      endValue: Vector3,
      gradient: number
    ): Vector3 {
    ...
    public vector3InterpolateFunctionWithTangents(
      startValue: Vector3,
      outTangent: Vector3,
      endValue: Vector3,
      inTangent: Vector3,
    ...
    public vector2InterpolateFunction(
      startValue: Vector2,
      endValue: Vector2,
      gradient: number
    ): Vector2 {
    ...
    public vector2InterpolateFunctionWithTangents(
      startValue: Vector2,
      outTangent: Vector2,
      endValue: Vector2,
      inTangent: Vector2,
    ...
    public sizeInterpolateFunction(
      startValue: Size,
      endValue: Size,
      gradient: number
    ): Size {
    ...
    public color3InterpolateFunction(
      startValue: Color3,
      endValue: Color3,
      gradient: number
    ): Color3 {
    ...
    public matrixInterpolateFunction(
      startValue: Matrix,
      endValue: Matrix,
      gradient: number
    ): Matrix {
    ...
    public static AppendSerializedAnimations(
      source: IAnimatable,
      destination: any
    ): any {
      if (source.animations) {
        ...
        for (
          ...
          animationIndex < source.animations.length;
          animationIndex++
        ) {
