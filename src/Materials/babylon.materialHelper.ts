namespace BABYLON {
  export class MaterialHelper {
    ...
    public static PrepareDefinesForMergedUV(
      texture: BaseTexture,
      defines: any,
      key: string
    ): void {
    ...
    public static BindTextureMatrix(
      texture: BaseTexture,
    ...
    public static PrepareDefinesForFrameBoundValues(
      ...
      if (
        defines["CLIPPLANE"] !==
        (scene.clipPlane !== undefined && scene.clipPlane !== null)
      ) {
    ...
    public static PrepareDefinesForAttributes(
      ...
      if (
        !defines._areAttributesDirty &&
        defines._needNormals === defines._normals &&
    ...
    public static PrepareUniformsAndSamplersList(
      ...
      for (
        var lightIndex = 0;
        lightIndex < maxSimultaneousLights;
        lightIndex++
      ) {
    ...
    public static HandleFallbacksForShadows(
      defines: any,
    ...
    public static PrepareAttributesForMorphTargets(
      ...
      if (influencers > 0 && Engine.LastCreatedEngine) {
        var maxAttributesCount = Engine.LastCreatedEngine.getCaps()
          .maxVertexAttribs;
        var manager = (<Mesh>mesh).morphTargetManager;
    ...
    public static PrepareAttributesForBones(
      attribs: string[],
      mesh: AbstractMesh,
      defines: any,
      fallbacks: EffectFallbacks
    ...
    public static PrepareAttributesForInstances(
      attribs: string[],
      defines: any
    ): void {
    ...
    public static BindLightProperties(
      light: Light,
      effect: Effect,
      lightIndex: number
    ): void {
    ...
    public static BindFogParameters(
      scene: Scene,
      mesh: AbstractMesh,
      effect: Effect
    ): void {
    ...
    public static BindBonesParameters(
      mesh?: AbstractMesh,
      effect?: Effect
    ): void {
      if (
    ...
    public static BindMorphTargetParameters(
    ...
    public static BindLogDepth(
      ...
      if (defines["LOGARITHMICDEPTH"]) {
        effect.setFloat(
          ...
          2.0 / (Math.log((<Camera>scene.activeCamera).maxZ + 1.0) / Math.LN2)
        );
      }
    }
