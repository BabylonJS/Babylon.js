namespace BABYLON {
  export class UniformBuffer {
    ...
    private static _tempBuffer = new Float32Array(
      UniformBuffer._MAX_UNIFORM_SIZE
    );
    ...
    private _fillAlignment(size: number) {
      ...
      if (this._uniformLocationPointer % alignment !== 0) {
        ...
        this._uniformLocationPointer +=
          alignment - this._uniformLocationPointer % alignment;
    ...
    public _rebuild(): void {
      ...
      if (this._dynamic) {
        this._buffer = this._engine.createDynamicUniformBuffer(
          this._bufferData
        );
      } else {
