namespace BABYLON {
  ...
  export abstract class PBRBaseMaterial extends PushMaterial {
    ...
    private _lightingInfos: Vector4 = new Vector4(
      this._directIntensity,
    ...
    constructor(name: string, scene: Scene) {
      ...
      this.getRenderTargetTextures = (): SmartArray<RenderTargetTexture> => {
        ...
        if (
          ...
          this._reflectionTexture.isRenderTarget
        ) {
          this._renderTargets.push(<RenderTargetTexture>this
            ._reflectionTexture);
        }
      ...
      this._environmentBRDFTexture = TextureTools.GetEnvironmentBRDFTexture(
        scene
      );
    }
    ...
    public set useLogarithmicDepth(value: boolean) {
      this._useLogarithmicDepth =
        ...
        this.getScene()
          .getEngine()
          .getCaps().fragmentDepthSupported;
    }
    ...
    public isReadyForSubMesh(
      ...
      if (defines._areTexturesDirty) {
        ...
        if (scene.texturesEnabled) {
          ...
          if (StandardMaterial.SpecularTextureEnabled) {
            if (this._metallicTexture) {
              ...
              defines.ROUGHNESSSTOREINMETALMAPGREEN =
                !this._useRoughnessFromMetallicTextureAlpha &&
                this._useRoughnessFromMetallicTextureGreen;
        ...
        if (
          this._forceMetallicWorkflow ||
          (this._metallic !== undefined && this._metallic !== null) ||
          (this._roughness !== undefined && this._roughness !== null)
        ) {
          defines.METALLICWORKFLOW = true;
        } else {
          defines.METALLICWORKFLOW = false;
        ...
        defines.ALPHAFRESNEL =
          this._useAlphaFresnel || this._useLinearAlphaFresnel;
      ...
      if (
        ...
        if (bufferMesh) {
          if (bufferMesh.isVerticesDataPresent(VertexBuffer.NormalKind)) {
            ...
            let normalVertexBuffer = bufferMesh.getVertexBuffer(
            ...
            if (bufferMesh.isVerticesDataPresent(VertexBuffer.TangentKind)) {
              ...
              let tangentVertexBuffer = bufferMesh.getVertexBuffer(
      ...
      if (mustRebind) {
        ...
        if (
          ...
          if (scene.texturesEnabled) {
            if (this._albedoTexture && StandardMaterial.DiffuseTextureEnabled) {
              this._uniformBuffer.updateFloat2(
                "vAlbedoInfos",
                this._albedoTexture.coordinatesIndex,
                this._albedoTexture.level
              );
            ...
            if (StandardMaterial.SpecularTextureEnabled) {
              if (this._metallicTexture) {
                this._uniformBuffer.updateFloat3(
                  "vReflectivityInfos",
                  this._metallicTexture.coordinatesIndex,
                  this._metallicTexture.level,
                  this._ambientTextureStrength
                );
                MaterialHelper.BindTextureMatrix(
                  this._metallicTexture,
                ...
                this._uniformBuffer.updateFloat3(
                  "vReflectivityInfos",
                  this._reflectivityTexture.coordinatesIndex,
                  this._reflectivityTexture.level,
                  1.0
                );
                MaterialHelper.BindTextureMatrix(
                  this._reflectivityTexture,
              ...
              if (this._microSurfaceTexture) {
                this._uniformBuffer.updateFloat2(
                  "vMicroSurfaceSamplerInfos",
                  this._microSurfaceTexture.coordinatesIndex,
                  this._microSurfaceTexture.level
                );
                MaterialHelper.BindTextureMatrix(
                  this._microSurfaceTexture,
                  this._uniformBuffer,
            ...
            if (
              ...
              this._uniformBuffer.updateFloat3(
                ...
                this._bumpTexture.level,
                this._parallaxScaleBias
              );
              MaterialHelper.BindTextureMatrix(
                this._bumpTexture,
                this._uniformBuffer,
              ...
              if (scene._mirroredCameraPosition) {
                this._uniformBuffer.updateFloat2(
                  "vTangentSpaceParams",
                  this._invertNormalMapX ? 1.0 : -1.0,
                  this._invertNormalMapY ? 1.0 : -1.0
                );
              } else {
                this._uniformBuffer.updateFloat2(
                  "vTangentSpaceParams",
            ...
            if (
              ...
              this._uniformBuffer.updateFloat4(
                "vRefractionInfos",
                refractionTexture.level,
                this._indexOfRefraction,
                depth,
                this._invertRefractionY ? -1 : 1
              );
              this._uniformBuffer.updateFloat3(
                "vRefractionMicrosurfaceInfos",
          ...
          if (defines.METALLICWORKFLOW) {
            ...
            this._uniformBuffer.updateColor4(
              "vReflectivityColor",
              this._reflectivityColor,
              this._microSurface
            );
          }

          this._uniformBuffer.updateColor3(
            "vEmissiveColor",
            this._emissiveColor
          );
          this._uniformBuffer.updateColor3(
          ...
          this._uniformBuffer.updateVector4(
            "vLightingIntensity",
            this._lightingInfos
          );
        }
        ...
        if (scene.texturesEnabled) {
          ...
          if (refractionTexture && StandardMaterial.RefractionTextureEnabled) {
            if (defines.LODBASEDMICROSFURACE) {
              ...
              this._uniformBuffer.setTexture(
                "refractionSampler",
                refractionTexture._lodTextureMid || refractionTexture
              );
              this._uniformBuffer.setTexture(
                "refractionSamplerLow",
                refractionTexture._lodTextureLow || refractionTexture
              );
              this._uniformBuffer.setTexture(
                "refractionSamplerHigh",
                refractionTexture._lodTextureHigh || refractionTexture
              );
            }
          }
        ...
        // Colors
        scene.ambientColor.multiplyToRef(
          this._ambientColor,
          this._globalAmbientColor
        );

        var eyePosition = scene._forcedViewPosition
    ...
    public getAnimatables(): IAnimatable[] {
      ...
      if (
        this._albedoTexture &&
        this._albedoTexture.animations &&
        this._albedoTexture.animations.length > 0
      ) {
      ...
      if (
        this._ambientTexture &&
        this._ambientTexture.animations &&
        this._ambientTexture.animations.length > 0
      ) {
      ...
      if (
        this._reflectionTexture &&
        this._reflectionTexture.animations &&
        this._reflectionTexture.animations.length > 0
      ) {
      ...
      if (
        this._emissiveTexture &&
        this._emissiveTexture.animations &&
        this._emissiveTexture.animations.length > 0
      ) {
      ...
      if (
        this._metallicTexture &&
        this._metallicTexture.animations &&
        this._metallicTexture.animations.length > 0
      ) {
        results.push(this._metallicTexture);
      } else if (
        this._reflectivityTexture &&
        this._reflectivityTexture.animations &&
        this._reflectivityTexture.animations.length > 0
      ) {
      ...
      if (
        this._bumpTexture &&
        this._bumpTexture.animations &&
        this._bumpTexture.animations.length > 0
      ) {
      ...
      if (
        this._lightmapTexture &&
        this._lightmapTexture.animations &&
        this._lightmapTexture.animations.length > 0
      ) {
      ...
      if (
        this._refractionTexture &&
        this._refractionTexture.animations &&
        this._refractionTexture.animations.length > 0
      ) {
    ...
    public dispose(
      ...
      if (forceDisposeTextures) {
        ...
        if (
          this._environmentBRDFTexture &&
          this.getScene()._environmentBRDFTexture !==
            this._environmentBRDFTexture
        ) {
