namespace BABYLON {
  ...
  export class ColorCurves {
    ...
    @serialize() private _globalHue = 30;

    @serialize() private _globalDensity = 0;

    @serialize() private _globalSaturation = 0;

    @serialize() private _globalExposure = 0;
    ...
    @serialize() private _highlightsHue = 30;

    @serialize() private _highlightsDensity = 0;

    @serialize() private _highlightsSaturation = 0;

    @serialize() private _highlightsExposure = 0;
    ...
    @serialize() private _midtonesHue = 30;

    @serialize() private _midtonesDensity = 0;

    @serialize() private _midtonesSaturation = 0;

    @serialize() private _midtonesExposure = 0;
    ...
    public static Bind(
      ...
      if (colorCurves._dirty) {
        ...
        colorCurves._tempColor.multiplyToRef(
          colorCurves._globalCurve,
        ...
        colorCurves._highlightsCurve.subtractToRef(
          colorCurves._midtonesCurve,
          colorCurves._positiveCurve
        );
        colorCurves._midtonesCurve.subtractToRef(
          colorCurves._shadowsCurve,
