namespace BABYLON {
  ...
  export class ImageProcessingConfiguration {
    ...
    @serialize() private _colorCurvesEnabled = false;
    /**
     ...
     */
    @serializeAsTexture() public colorGradingTexture: Nullable<BaseTexture>;

    @serialize() private _colorGradingEnabled = false;
    /**
    ...
    @serialize() private _colorGradingWithGreenDepth = true;
    /**
    ...
    @serialize() private _colorGradingBGR = true;
    /**
    ...
    @serialize() public _exposure = 1.0;
    /**
    ...
    @serialize() private _toneMappingEnabled = false;
    /**
    ...
    @serialize() protected _contrast = 1.0;
    /**
     ...
     */
    @serialize() public vignetteStretch = 0;

    /**
     * Vignette centre X Offset.
     */
    @serialize() public vignetteCentreX = 0;

    /**
     * Vignette centre Y Offset.
     */
    @serialize() public vignetteCentreY = 0;

    /**
     * Vignette weight or intensity of the vignette effect.
     */
    @serialize() public vignetteWeight = 1.5;

    /**
     * Color of the vignette applied on the screen through the chosen blend mode (vignetteBlendMode)
     * if vignetteEnabled is set to true.
     */
    @serializeAsColor4() public vignetteColor: Color4 = new Color4(0, 0, 0, 0);

    /**
     * Camera field of view used by the Vignette effect.
     */
    @serialize() public vignetteCameraFov = 0.5;
    ...
    @serialize() private _vignetteEnabled = false;
    /**
    ...
    @serialize() private _applyByPostProcess = false;
    /**
    ...
    @serialize() private _isEnabled = true;
    /**
    ...
    public prepareDefines(
      ...
      if (forPostProcess !== this.applyByPostProcess || !this._isEnabled) {
        ...
        defines.IMAGEPROCESSINGPOSTPROCESS =
          this.applyByPostProcess && this._isEnabled;
        return;
      }
      ...
      defines.VIGNETTEBLENDMODEMULTIPLY =
        ...
        ImageProcessingConfiguration._VIGNETTEMODE_MULTIPLY;
      ...
      defines.COLORGRADING =
        this.colorGradingEnabled && !!this.colorGradingTexture;
      if (defines.COLORGRADING) {
    ...
    public isReady() {
      ...
      return (
        !this.colorGradingEnabled ||
        !this.colorGradingTexture ||
        this.colorGradingTexture.isReady()
      );
    }
    ...
    public bind(effect: Effect, aspectRatio = 1): void {
      ...
      if (this._vignetteEnabled) {
        ...
        let vignetteScaleGeometricMean = Math.sqrt(
          vignetteScaleX * vignetteScaleY
        );
        vignetteScaleX = Tools.Mix(
          vignetteScaleX,
          vignetteScaleGeometricMean,
          this.vignetteStretch
        );
        vignetteScaleY = Tools.Mix(
          vignetteScaleY,
          vignetteScaleGeometricMean,
          this.vignetteStretch
        );
        ...
        effect.setFloat4(
          ...
          vignetteScaleX,
          vignetteScaleY,
          -vignetteScaleX * this.vignetteCentreX,
          -vignetteScaleY * this.vignetteCentreY
        );
