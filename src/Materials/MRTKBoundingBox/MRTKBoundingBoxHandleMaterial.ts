...
import "../../shaders/mrtkBoundingBoxHandle.vertex";
import "../../shaders/mrtkBoundingBoxHandle.fragment";

/**
 * Class used to render gizmo handles with fluent design
 */
export class MRTKBoundingBoxHandleMaterial extends ShaderMaterial {
