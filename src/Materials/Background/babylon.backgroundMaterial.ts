namespace BABYLON {
  ...
  export class BackgroundMaterial extends PushMaterial {
     ...
     */
    @serializeAsColor3() protected _primaryColor: Color3;
     ...
     */
    @serialize() protected _secondaryLevel: float;
    @expandToProperty("_markAllSubMeshesAsLightsDirty")
     ...
     */
    @serializeAsColor3() protected _tertiaryColor: Color3;
    @expandToProperty("_markAllSubMeshesAsLightsDirty")
     ...
     */
    @serialize() protected _tertiaryLevel: float;
    @expandToProperty("_markAllSubMeshesAsLightsDirty")
     ...
     */
    @serializeAsTexture() protected _reflectionTexture: Nullable<BaseTexture>;
     ...
     * texture twice.
     */
    @serialize() protected _reflectionBlur: float;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     * Should be author in a specific way for the best result (refer to the documentation).
     */
    @serializeAsTexture() protected _diffuseTexture: Nullable<BaseTexture>;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _shadowBlurScale: int;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _shadowLevel: float;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serializeAsVector3() protected _sceneCenter: Vector3;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _opacityFresnel: boolean;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _reflectionFresnel: boolean;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _reflectionFalloffDistance: number;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _reflectionAmount: number;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _reflectionReflectance0: number;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _reflectionReflectance90: number;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
    ...
    public set reflectionStandardFresnelWeight(value: number) {
      ...
      if (reflectionWeight < 0.5) {
        ...
        this.reflectionReflectance0 =
          ...
          (1.0 - BackgroundMaterial.standardReflectance0) * reflectionWeight;
        this.reflectionReflectance90 =
          BackgroundMaterial.standardReflectance90 +
          (1.0 - BackgroundMaterial.standardReflectance90) * reflectionWeight;
      }
    }
     ...
     */
    @serialize() protected _useRGBColor: boolean;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() protected _enableNoise: boolean;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
     ...
     */
    @serialize() private _maxSimultaneousLights: int = 4;
    @expandToProperty("_markAllSubMeshesAsTexturesDirty")
    ...
    private _imageProcessingObserver: Nullable<
      Observer<ImageProcessingConfiguration>
    > = null;
     ...
     */
    protected _attachImageProcessingConfiguration(
      configuration: Nullable<ImageProcessingConfiguration>
    ): void {
     ...
     */
    public set imageProcessingConfiguration(
    ...
    public get cameraColorCurvesEnabled(): boolean {
      return (<ImageProcessingConfiguration>this.imageProcessingConfiguration)
        .colorCurvesEnabled;
    }
    /**
    ...
    public set cameraColorGradingTexture(value: Nullable<BaseTexture>) {
      (<ImageProcessingConfiguration>this
        .imageProcessingConfiguration).colorGradingTexture = value;
    }
    ...
    public set cameraColorCurves(value: Nullable<ColorCurves>) {
      (<ImageProcessingConfiguration>this
        .imageProcessingConfiguration).colorCurves = value;
    }
    ...
    constructor(name: string, scene: Scene) {
      ...
      this.getRenderTargetTextures = (): SmartArray<RenderTargetTexture> => {
        ...
        if (this._reflectionTexture && this._reflectionTexture.isRenderTarget) {
          this._renderTargets.push(this
            ._reflectionTexture as RenderTargetTexture);
        }
    ...
    public needAlphaBlending(): boolean {
      return (
        this.alpha < 0 ||
        (this._diffuseTexture != null && this._diffuseTexture.hasAlpha)
      );
    }
      ...
      if (defines._areTexturesDirty) {
        ...
        if (scene.texturesEnabled) {
          ...
          if (reflectionTexture && StandardMaterial.ReflectionTextureEnabled) {
            ...
            defines.REFLECTIONMAP_OPPOSITEZ = this.getScene()
        ...
        defines.PREMULTIPLYALPHA =
          this.alphaMode === Engine.ALPHA_PREMULTIPLIED ||
          this.alphaMode === Engine.ALPHA_PREMULTIPLIED_PORTERDUFF;
      ...
      if (
        ...
        if (mesh) {
          if (
            ...
            Tools.Warn(
              "BackgroundMaterial: Normals have been created for the mesh: " +
                mesh.name
            );
          }
        }
        ...
        if (
          ...
          if (scene.texturesEnabled) {
            ...
            if (
              ...
              this._uniformBuffer.updateMatrix(
                "reflectionMatrix",
        ...
        if (scene.texturesEnabled) {
          ...
          if (reflectionTexture && StandardMaterial.ReflectionTextureEnabled) {
            if (defines.REFLECTIONBLUR && defines.TEXTURELODSUPPORT) {
              ...
              this._uniformBuffer.setTexture(
                "reflectionSampler",
                reflectionTexture._lodTextureMid || reflectionTexture
              );
              this._uniformBuffer.setTexture(
                "reflectionSamplerLow",
                reflectionTexture._lodTextureLow || reflectionTexture
              );
              this._uniformBuffer.setTexture(
                "reflectionSamplerHigh",
                reflectionTexture._lodTextureHigh || reflectionTexture
              );
            }
     ...
     */
    public dispose(
      forceDisposeEffect: boolean = false,
      forceDisposeTextures: boolean = false
    ): void {
    ...
    public clone(name: string): BackgroundMaterial {
      return SerializationHelper.Clone(
        () => new BackgroundMaterial(name, this.getScene()),
        this
      );
    }
    ...
    public static Parse(
      ...
      return SerializationHelper.Parse(
        () => new BackgroundMaterial(source.name, scene),
        source,
        scene,
        rootUrl
      );
