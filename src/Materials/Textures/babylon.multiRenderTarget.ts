  ...
  export class MultiRenderTarget extends RenderTargetTexture {
    ...
    public get isSupported(): boolean {
      return (
        ...
        this._engine.getCaps().drawBuffersExtension
      );
    }
    ...
    private _createInternalTextures(): void {
      this._internalTextures = this._engine.createMultipleRenderTarget(
        this._size,
        this._multiRenderTargetOptions
      );
    }
    ...
    public set samples(value: number) {
      ...
      this._samples = this._engine.updateMultipleRenderTargetTextureSampleCount(
