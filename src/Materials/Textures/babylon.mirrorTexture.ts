namespace BABYLON {
  export class MirrorTexture extends RenderTargetTexture {
    ...
    constructor(
      ...
      type: number = Engine.TEXTURETYPE_UNSIGNED_INT,
      ...
      this.onBeforeRenderObservable.add(() => {
        ...
        this._mirrorMatrix.multiplyToRef(
          this._savedViewMatrix,
        ...
        scene._mirroredCameraPosition = Vector3.TransformCoordinates(
          (<Camera>scene.activeCamera).globalPosition,
          this._mirrorMatrix
        );
      });
    ...
    private _preparePostProcesses(): void {
      ...
      if (this._blurKernelX && this._blurKernelY) {
        ...
        var textureType = engine.getCaps().textureFloatRender
