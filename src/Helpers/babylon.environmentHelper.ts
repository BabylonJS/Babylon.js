  ...
  export class EnvironmentHelper {
    ...
    public setMainColor(color: Color3): void {
      ...
      if (this.groundMirror) {
        this.groundMirror.clearColor = new Color4(
          color.r,
          color.g,
          color.b,
          1.0
    ...
    private _setupEnvironmentTexture(): void {
      ...
      const environmentTexture = CubeTexture.CreateFromPrefilteredData(
        this._options.environmentTexture,
        this._scene
      );
    ...
    private _setupGround(sceneSize: ISceneSize): void {
      if (!this._ground) {
        this._ground = Mesh.CreatePlane(
          "BackgroundPlane",
          sceneSize.groundSize,
          this._scene
        );
    ...
    private _setupGroundMaterial(): void {
      if (!this._groundMaterial) {
        this._groundMaterial = new BackgroundMaterial(
    ...
    private _setupGroundMirrorTexture(sceneSize: ISceneSize): void {
      ...
      if (!this._groundMirror) {
        ...
        this._groundMirror.mirrorPlane = new Plane(
          0,
          -1,
          0,
          sceneSize.rootPosition.y
        );
    ...
    private _setupSkyboxMaterial(): void {
      ...
      if (!this._skyboxMaterial) {
        this._skyboxMaterial = new BackgroundMaterial(
