namespace BABYLON {
  export class SwitchBooleanAction extends Action {
    ...
    public execute(): void {
      this._effectiveTarget[this._property] = !this._effectiveTarget[
        this._property
      ];
    }
  ...
  export class IncrementValueAction extends Action {
    ...
    public _prepare(): void {
      ...
      if (typeof this._effectiveTarget[this._property] !== "number") {
        Tools.Warn(
          "Warning: IncrementValueAction can only be used with number values"
        );
      }
    }
  ...
  export class DoNothingAction extends Action {
    constructor(
      triggerOptions: any = ActionManager.NothingTrigger,
      condition?: Condition
    ) {
      super(triggerOptions, condition);
    }
  ...
  export class SetParentAction extends Action {
    ...
    public execute(): void {
      ...
      this._target.position = Vector3.TransformCoordinates(
