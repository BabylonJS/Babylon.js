namespace BABYLON {
  export class InterpolateValueAction extends Action {
    ...
    public _prepare(): void {
      this._effectiveTarget = this._getEffectiveTarget(
        this._effectiveTarget,
        this.propertyPath
      );
    ...
    public execute(): void {
      ...
      if (typeof this.value === "number") {
        ...
        Tools.Warn(
          "InterpolateValueAction: Unsupported type (" + typeof this.value + ")"
        );
        return;
      }
      ...
      return super._serialize(
        {
          ...
          properties: [
            ...
            },
            {
              ...
              value:
                Action._SerializeValueAsString(this.stopOtherAnimations) ||
                false
            }
          ]
        },
