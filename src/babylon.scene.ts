namespace BABYLON {
  ...
  export class Scene implements IAnimatable {
    ...
    public set afterRender(callback: Nullable<() => void>) {
      ...
      if (callback) {
        this._onAfterRenderObserver = this.onAfterRenderObservable.add(
          callback
        );
      }
    }
    ...
    public set beforeCameraRender(callback: () => void) {
      if (this._onBeforeCameraRenderObserver) {
        this.onBeforeCameraRenderObservable.remove(
          this._onBeforeCameraRenderObserver
        );
      }

      this._onBeforeCameraRenderObserver = this.onBeforeCameraRenderObservable.add(
        callback
      );
    }
    ...
    public set afterCameraRender(callback: () => void) {
      if (this._onAfterCameraRenderObserver) {
        this.onAfterCameraRenderObservable.remove(
          this._onAfterCameraRenderObserver
        );
      }
      this._onAfterCameraRenderObserver = this.onAfterCameraRenderObservable.add(
        callback
      );
    }
    ...
    private _initClickEvent: (
      ...
      evt: PointerEvent,
      cb: (clickInfo: ClickInfo, pickResult: Nullable<PickingInfo>) => void
    ) => void;
    private _initActionManager: (
      act: Nullable<ActionManager>,
      clickInfo: ClickInfo
    ) => Nullable<ActionManager>;
    ...
    private _meshesForIntersections = new SmartArrayNoDuplicate<AbstractMesh>(
      256
    );
    ...
    private _renderTargets = new SmartArrayNoDuplicate<RenderTargetTexture>(
      256
    );
     ...
     */
    public set geometryBufferRenderer(
    ...
    public set workerCollisions(enabled: boolean) {
      ...
      this.collisionCoordinator = enabled
        ? new CollisionCoordinatorWorker()
        : new CollisionCoordinatorLegacy();
    ...
    public isCachedMaterialInvalid(
      material: Material,
      effect: Effect,
      visibility: number = 1
    ) {
      return (
        ...
        this._cachedMaterial !== material ||
        this._cachedVisibility !== visibility
      );
    }
    ...
    public getInterFramePerfCounter(): number {
      Tools.Warn(
        "getInterFramePerfCounter is deprecated. Please use SceneInstrumentation class"
      );
      return 0;
    }
    ...
    public get interFramePerfCounter(): Nullable<PerfCounter> {
      Tools.Warn(
        "interFramePerfCounter is deprecated. Please use SceneInstrumentation class"
      );
      return null;
    }
    ...
    public getLastFrameDuration(): number {
      Tools.Warn(
        "getLastFrameDuration is deprecated. Please use SceneInstrumentation class"
      );
      return 0;
    }
    ...
    public get lastFramePerfCounter(): Nullable<PerfCounter> {
      Tools.Warn(
        "lastFramePerfCounter is deprecated. Please use SceneInstrumentation class"
      );
      return null;
    }
    ...
    public getEvaluateActiveMeshesDuration(): number {
      Tools.Warn(
        "getEvaluateActiveMeshesDuration is deprecated. Please use SceneInstrumentation class"
      );
      return 0;
    }

    public get evaluateActiveMeshesDurationPerfCounter(): Nullable<
      PerfCounter
    > {
      Tools.Warn(
        "evaluateActiveMeshesDurationPerfCounter is deprecated. Please use SceneInstrumentation class"
      );
      return null;
    }
    ...
    public getRenderTargetsDuration(): number {
      Tools.Warn(
        "getRenderTargetsDuration is deprecated. Please use SceneInstrumentation class"
      );
      return 0;
    }
    ...
    public getRenderDuration(): number {
      Tools.Warn(
        "getRenderDuration is deprecated. Please use SceneInstrumentation class"
      );
      return 0;
    }
    ...
    public get renderDurationPerfCounter(): Nullable<PerfCounter> {
      Tools.Warn(
        "renderDurationPerfCounter is deprecated. Please use SceneInstrumentation class"
      );
      return null;
    }
    ...
    public getParticlesDuration(): number {
      Tools.Warn(
        "getParticlesDuration is deprecated. Please use SceneInstrumentation class"
      );
      return 0;
    }
    ...
    public get particlesDurationPerfCounter(): Nullable<PerfCounter> {
      Tools.Warn(
        "particlesDurationPerfCounter is deprecated. Please use SceneInstrumentation class"
      );
      return null;
    }
    ...
    public getSpritesDuration(): number {
      Tools.Warn(
        "getSpritesDuration is deprecated. Please use SceneInstrumentation class"
      );
      return 0;
    }
    ...
    public get spriteDuractionPerfCounter(): Nullable<PerfCounter> {
      Tools.Warn(
        "spriteDuractionPerfCounter is deprecated. Please use SceneInstrumentation class"
      );
      return null;
    }
    ...
    private _createAlternateUbo(): void {
      this._alternateSceneUbo = new UniformBuffer(
        this._engine,
        undefined,
        true
      );
    ...
    private _processPointerMove(
      ...
      if (pickResult && pickResult.hit && pickResult.pickedMesh) {
        ...
        // Sprites
        pickResult = this.pickSprite(
          this._unTranslatedPointerX,
          this._unTranslatedPointerY,
          this._spritePredicate,
          false,
          this.cameraToUseForPointers || undefined
        );
      ...
      if (pickResult) {
        ...
        if (this.onPointerObservable.hasObservers()) {
          let type =
            evt.type === "mousewheel" || evt.type === "DOMMouseScroll"
    ...
    private _processPointerDown(
      ...
      if (pickResult && pickResult.hit && pickResult.pickedMesh) {
        ...
        if (actionManager) {
          ...
          if (
            actionManager.hasSpecificTrigger(ActionManager.OnLongPressTrigger)
          ) {
            window.setTimeout(() => {
              ...
              if (
                ...
                if (
                  ...
                  new Date().getTime() - this._startingPointerTime >
                    Scene.LongPressDelay &&
                  (Math.abs(this._startingPointerPosition.x - this._pointerX) <
                    Scene.DragMovementThreshold &&
                    Math.abs(this._startingPointerPosition.y - this._pointerY) <
                      Scene.DragMovementThreshold)
                ) {
    ...
    private _processPointerUp(
      ...
      if (
        this._pickedDownMesh &&
        this._pickedDownMesh.actionManager &&
        this._pickedDownMesh.actionManager.hasSpecificTrigger(
          ActionManager.OnPickOutTrigger
        ) &&
        this._pickedDownMesh !== this._pickedUpMesh
      ) {
        this._pickedDownMesh.actionManager.processTrigger(
          ActionManager.OnPickOutTrigger,
          ActionEvent.CreateNew(this._pickedDownMesh, evt)
        );
      }
      ...
      if (this.onPointerObservable.hasObservers()) {
        if (!clickInfo.ignore) {
          if (!clickInfo.hasSwiped) {
            if (
              clickInfo.singleClick &&
              this.onPointerObservable.hasSpecificMask(
    ...
    public attachControl(
      ...
      this._initActionManager = (
        ...
        if (!this._meshPickProceed) {
          ...
          if (pickResult) {
            act =
              pickResult.hit && pickResult.pickedMesh
      ...
      this._delayedSimpleClick = (
        ...
        if (
          (new Date().getTime() - this._previousStartingPointerTime >
        ...
        if (checkPicking) {
          ...
          if (!clickInfo.hasSwiped) {
            ...
            if (checkSingleClickImmediately) {
              ...
              this._delayedSimpleClickTimeout = window.setTimeout(
                this._delayedSimpleClick.bind(this, btn, clickInfo, cb),
                Scene.DoubleClickDelay
              );
            }
            ...
            if (
              ...
              act = this._initActionManager(act, clickInfo);
              if (act)
                checkDoubleClick = act.hasSpecificTrigger(
                  ActionManager.OnDoublePickTrigger
                );
            }
            if (checkDoubleClick) {
              ...
              if (
                ...
                if (
                  !clickInfo.hasSwiped &&
                  Math.abs(
                    this._previousStartingPointerPosition.x -
                      this._startingPointerPosition.x
                  ) < Scene.DragMovementThreshold &&
                  Math.abs(
                    this._previousStartingPointerPosition.y -
                      this._startingPointerPosition.y
                  ) < Scene.DragMovementThreshold
                ) {
      ...
      this._onPointerMove = (evt: PointerEvent) => {
        ...
        if (!this.pointerMovePredicate) {
          this.pointerMovePredicate = (mesh: AbstractMesh): boolean =>
            mesh.isPickable &&
            mesh.isVisible &&
            mesh.isReady() &&
            mesh.isEnabled() &&
      ...
      this._onPointerUp = (evt: PointerEvent) => {
        ...
        this._initClickEvent(
          ...
          evt,
          (clickInfo: ClickInfo, pickResult: Nullable<PickingInfo>) => {
            // PreObservable support
            if (this.onPrePointerObservable.hasObservers()) {
              if (!clickInfo.ignore) {
                if (!clickInfo.hasSwiped) {
                  if (
                    clickInfo.singleClick &&
                    this.onPrePointerObservable.hasSpecificMask(
                      PointerEventTypes.POINTERTAP
                    )
                  ) {
                    let type = PointerEventTypes.POINTERTAP;
            ...
            if (
              ...
              ((ActionManager && ActionManager.HasTriggers) ||
                this.onPointerObservable.hasObservers())
            ) {
            ...
            // Sprites
            if (this.spriteManagers.length > 0) {
              let spritePickResult = this.pickSprite(
                this._unTranslatedPointerX,
                this._unTranslatedPointerY,
                this._spritePredicate,
                false,
              ...
              if (spritePickResult) {
                ...
                if (
                  this._pickedDownSprite &&
                  this._pickedDownSprite.actionManager &&
                  this._pickedDownSprite !== spritePickResult.pickedSprite
                ) {
                  this._pickedDownSprite.actionManager.processTrigger(
                    ActionManager.OnPickOutTrigger,
                    ActionEvent.CreateNewFromSprite(
                      this._pickedDownSprite,
                      this,
      ...
      this._onKeyDown = (evt: KeyboardEvent) => {
        ...
        if (this.actionManager) {
          this.actionManager.processTrigger(
    ...
    public detachControl() {
      ...
      canvas.removeEventListener(eventPrefix + "move", <any>this
        ._onPointerMove);
      canvas.removeEventListener(eventPrefix + "down", <any>this
        ._onPointerDown);
     ...
     */
    public beginDirectHierarchyAnimation(
      target: Node,
    ...
    private _animate(): void {
      ...
      var deltaTime = this.useConstantAnimationDeltaTime
        ? 16.0
    ...
    public getViewMatrix(): Matrix {
      return this._useAlternateCameraConfiguration
        ? this._alternateViewMatrix
        : this._viewMatrix;
    }

    public getProjectionMatrix(): Matrix {
      return this._useAlternateCameraConfiguration
        ? this._alternateProjectionMatrix
        : this._projectionMatrix;
    }

    public getTransformMatrix(): Matrix {
      return this._useAlternateCameraConfiguration
        ? this._alternateTransformMatrix
    ...
    public setTransformMatrix(view: Matrix, projection: Matrix): void {
      ...
      if (this.activeCamera && this.activeCamera._alternateCamera) {
        ...
        otherCamera
          .getViewMatrix()
          .multiplyToRef(otherCamera.getProjectionMatrix(), Tmp.Matrix[0]);
    ...
    public _setAlternateTransformMatrix(
      view: Matrix,
      projection: Matrix
    ): void {
      if (
      ...
      this._alternateViewMatrix.multiplyToRef(
        this._alternateProjectionMatrix,
        this._alternateTransformMatrix
      );
      ...
      if (this._alternateSceneUbo.useUbo) {
        this._alternateSceneUbo.updateMatrix(
          "viewProjection",
          this._alternateTransformMatrix
        );
    ...
    public getBoneByID(id: string): Nullable<Bone> {
      for (
        var skeletonIndex = 0;
        skeletonIndex < this.skeletons.length;
        skeletonIndex++
      ) {
        var skeleton = this.skeletons[skeletonIndex];
        for (
          var boneIndex = 0;
          boneIndex < skeleton.bones.length;
          boneIndex++
        ) {
    ...
    public getSoundByName(name: string): Nullable<Sound> {
      ...
      if (AudioEngine) {
        for (
          index = 0;
          index < this.mainSoundTrack.soundCollection.length;
          index++
        ) {
        ...
        for (var sdIndex = 0; sdIndex < this.soundTracks.length; sdIndex++) {
          for (
            index = 0;
            index < this.soundTracks[sdIndex].soundCollection.length;
            index++
          ) {
            if (
              this.soundTracks[sdIndex].soundCollection[index].name === name
            ) {
      ...
      if (
        ...
        if (mesh.showSubMeshesBoundingBox) {
          ...
          if (boundingInfo !== null && boundingInfo !== undefined) {
            this.getBoundingBoxRenderer().renderList.push(
    ...
    public setActiveMeshCandidateProvider(
      provider: IActiveMeshCandidateProvider
    ): void {
    ...
    private _evaluateActiveMeshes(): void {
      ...
      if (this._activeMeshCandidateProvider !== undefined) {
        ...
        checkIsEnabled =
          this._activeMeshCandidateProvider.checksIsEnabled === false;
        if (meshes !== undefined) {
          len = meshes.length;
        } else {
          len = 0;
      ...
      if (this.particlesEnabled) {
        ...
        for (
          var particleIndex = 0;
          particleIndex < this.particleSystems.length;
          particleIndex++
        ) {
    ...
    private _activeMesh(sourceMesh: AbstractMesh, mesh: AbstractMesh): void {
      ...
      if (
        ...
        if (
          ...
          mesh._submeshesOctree !== undefined &&
          mesh._submeshesOctree !== null
        ) {
    ...
    public updateTransformMatrix(force?: boolean): void {
      ...
      this.setTransformMatrix(
        ...
        this.activeCamera.getProjectionMatrix(force)
      );
    }

    public updateAlternateTransformMatrix(alternateCamera: Camera): void {
      this._setAlternateTransformMatrix(
        alternateCamera.getViewMatrix(),
    ...
    private _renderForCamera(camera: Camera): void {
      ...
      Tools.StartPerformanceCounter(
        "Rendering camera " + this.activeCamera.name
      );
      ...
      // Software skinning
      for (
        var softwareSkinnedMeshIndex = 0;
        softwareSkinnedMeshIndex < this._softwareSkinnedMeshes.length;
        softwareSkinnedMeshIndex++
      ) {
      ...
      if (this.renderTargetsEnabled && this._renderTargets.length > 0) {
        ...
        for (
          var renderIndex = 0;
          renderIndex < this._renderTargets.length;
          renderIndex++
        ) {
          let renderTarget = this._renderTargets.data[renderIndex];
          if (renderTarget._shouldRender()) {
            this._renderId++;
            var hasSpecialRenderTargetCamera =
              renderTarget.activeCamera &&
              renderTarget.activeCamera !== this.activeCamera;
            renderTarget.render(
              <boolean>hasSpecialRenderTargetCamera,
              this.dumpNextRenderTargets
            );
          }
        }
      ...
      if (
        this.renderTargetsEnabled &&
        this.highlightLayers &&
        this.highlightLayers.length > 0
      ) {
        this._intermediateRendering = true;
        for (let i = 0; i < this.highlightLayers.length; i++) {
          ...
          if (
            highlightLayer.shouldRender() &&
            (!highlightLayer.camera ||
              (highlightLayer.camera.cameraRigMode === Camera.RIG_MODE_NONE &&
                camera === highlightLayer.camera) ||
              (highlightLayer.camera.cameraRigMode !== Camera.RIG_MODE_NONE &&
                highlightLayer.camera._rigCameras.indexOf(camera) > -1))
          ) {
            renderhighlights = true;

            let renderTarget = <RenderTargetTexture>(<any>highlightLayer)
              ._mainTexture;
            if (renderTarget._shouldRender()) {
              this._renderId++;
      ...
      if (this.layers.length) {
        ...
        for (layerIndex = 0; layerIndex < this.layers.length; layerIndex++) {
          ...
          if (
            layer.isBackground &&
            (layer.layerMask & this.activeCamera.layerMask) !== 0
          ) {
            layer.render();
          }
        }
      ...
      if (this.lensFlaresEnabled) {
        Tools.StartPerformanceCounter(
          "Lens flares",
          this.lensFlareSystems.length > 0
        );
        for (
          var lensFlareSystemIndex = 0;
          lensFlareSystemIndex < this.lensFlareSystems.length;
          lensFlareSystemIndex++
        ) {
    ...
    private _checkIntersections(): void {
      for (
        var index = 0;
        index < this._meshesForIntersections.length;
        index++
      ) {
        ...
        for (
          var actionIndex = 0;
          actionIndex < sourceMesh.actionManager.actions.length;
          actionIndex++
        ) {
          ...
          if (
            ...
            var otherMesh =
              parameters instanceof AbstractMesh ? parameters : parameters.mesh;

            var areIntersecting = otherMesh.intersectsMesh(
              sourceMesh,
              parameters.usePreciseIntersection
            );
            var currentIntersectionInProgress = sourceMesh._intersectionsInProgress.indexOf(
              otherMesh
            );
            ...
            if (areIntersecting && currentIntersectionInProgress === -1) {
              if (action.trigger === ActionManager.OnIntersectionEnterTrigger) {
                action._executeCurrent(
                  ActionEvent.CreateNew(sourceMesh, undefined, otherMesh)
                );
              ...
              if (
                !sourceMesh.actionManager.hasSpecificTrigger(
                  ActionManager.OnIntersectionExitTrigger
                ) ||
                action.trigger === ActionManager.OnIntersectionExitTrigger
              ) {
                sourceMesh._intersectionsInProgress.splice(
                  currentIntersectionInProgress,
                  1
                );
              }
            }
    ...
    public render(): void {
      ...
      if (this._engine.isDeterministicLockStep()) {
        var deltaTime =
          Math.max(
            Scene.MinDeltaTime,
            Math.min(this._engine.getDeltaTime(), Scene.MaxDeltaTime)
      ...
      if (this.renderTargetsEnabled) {
        ...
        for (
          var customIndex = 0;
          customIndex < this.customRenderTargets.length;
          customIndex++
        ) {
          ...
          if (renderTarget._shouldRender()) {
            ...
            renderTarget.render(
              currentActiveCamera !== this.activeCamera,
              this.dumpNextRenderTargets
            );
          }
        }
      ...
      if (this.proceduralTexturesEnabled) {
        Tools.StartPerformanceCounter(
          "Procedural textures",
          this._proceduralTextures.length > 0
        );
        for (
          var proceduralIndex = 0;
          proceduralIndex < this._proceduralTextures.length;
          proceduralIndex++
        ) {
      ...
      if (this.activeCameras.length > 0) {
        for (
          var cameraIndex = 0;
          cameraIndex < this.activeCameras.length;
          cameraIndex++
        ) {
          if (cameraIndex > 0) {
    ...
    private _updateAudioParameters() {
      if (
        ...
        (this._mainSoundTrack.soundCollection.length === 0 &&
          this.soundTracks.length === 1)
      ) {
        return;
      }
      ...
      if (
        listeningCamera &&
        audioEngine.canUseWebAudio &&
        audioEngine.audioContext
      ) {
        audioEngine.audioContext.listener.setPosition(
          listeningCamera.position.x,
          listeningCamera.position.y,
          listeningCamera.position.z
        );
        // for VR cameras
        if (
          listeningCamera.rigCameras &&
          listeningCamera.rigCameras.length > 0
        ) {
          listeningCamera = listeningCamera.rigCameras[0];
        }
        var mat = Matrix.Invert(listeningCamera.getViewMatrix());
        var cameraDirection = Vector3.TransformNormal(
          new Vector3(0, 0, -1),
          mat
        );
        ...
        if (
          !isNaN(cameraDirection.x) &&
          !isNaN(cameraDirection.y) &&
          !isNaN(cameraDirection.z)
        ) {
          audioEngine.audioContext.listener.setOrientation(
            cameraDirection.x,
            cameraDirection.y,
            cameraDirection.z,
            0,
    ...
    public enableGeometryBufferRenderer(
      ratio: number = 1
    ...
    public createOrUpdateSelectionOctree(
      ...
      if (!this._selectionOctree) {
        this._selectionOctree = new Octree<AbstractMesh>(
          Octree.CreationFuncForMeshes,
          maxCapacity,
          maxDepth
        );
      }
    ...
    public createPickingRayToRef(
      ...
      y =
        y / this._engine.getHardwareScalingLevel() -
        (this._engine.getRenderHeight() - viewport.y - viewport.height);
      ...
      result.update(
        ...
        cameraViewSpace ? Matrix.Identity() : camera.getViewMatrix(),
        camera.getProjectionMatrix()
      );
      return this;
    }

    public createPickingRayInCameraSpace(
      x: number,
      y: number,
      camera?: Camera
    ): Ray {
    ...
    public createPickingRayInCameraSpaceToRef(
      x: number,
      y: number,
      result: Ray,
      camera?: Camera
    ...
    private _internalPickSprites(
      ...
      if (this.spriteManagers.length > 0) {
        for (
          var spriteIndex = 0;
          spriteIndex < this.spriteManagers.length;
          spriteIndex++
        ) {
          ...
          var result = spriteManager.intersects(
            ray,
            camera,
            predicate,
            fastCheck
    ...
    public pick(
      ...
      return this._internalPick(
        world => {
          this.createPickingRayToRef(
            x,
            y,
            world,
            this._tempPickingRay!,
            camera || null
          );
    ...
    public pickSprite(
      ...
      return this._internalPickSprites(
        this._tempPickingRay!,
        predicate,
        fastCheck,
        camera
    ...
    public pickWithRay(
      ...
      return this._internalPick(
        world => {
          ...
          Ray.TransformToRef(
            ray,
            this._pickWithRayInverseMatrix,
            this._cachedRayForTransform
          );
    ...
    public multiPick(
      ...
      return this._internalMultiPick(
        world => this.createPickingRay(x, y, world, camera || null),
        predicate
      );
    }
    ...
    public setPointerOverMesh(mesh: Nullable<AbstractMesh>): void {
      ...
      if (this._pointerOverMesh && this._pointerOverMesh.actionManager) {
        this._pointerOverMesh.actionManager.processTrigger(
          ActionManager.OnPointerOutTrigger,
          ActionEvent.CreateNew(this._pointerOverMesh)
        );
      }
    ...
    public setPointerOverSprite(sprite: Nullable<Sprite>): void {
      ...
      if (this._pointerOverSprite && this._pointerOverSprite.actionManager) {
        this._pointerOverSprite.actionManager.processTrigger(
          ActionManager.OnPointerOutTrigger,
          ActionEvent.CreateNewFromSprite(this._pointerOverSprite, this)
        );
      }
    ...
    public createDefaultCameraOrLight(
      ...
      if (!this.activeCamera) {
        ...
        if (createArcRotateCamera) {
          var arcRotateCamera = new ArcRotateCamera(
            "default camera",
            -(Math.PI / 2),
            Math.PI / 2,
            radius,
          ...
          var freeCamera = new FreeCamera(
            "default camera",
            new Vector3(worldCenter.x, worldCenter.y, -radius),
            this
          );
    ...
    public createDefaultSkybox(
      ...
      if (!this.environmentTexture) {
        Tools.Warn(
          "Can not create default skybox without environment texture."
        );
        return null;
      }
    ...
    public createDefaultEnvironment(
      options: Partial<IEnvironmentHelperOptions>
    ): Nullable<EnvironmentHelper> {
    ...
    public getMaterialByTags(
      tagsQuery: string,
      forEach?: (material: Material) => void
    ): Material[] {
      return this._getByTags(this.materials, tagsQuery, forEach).concat(
        this._getByTags(this.multiMaterials, tagsQuery, forEach)
      );
    }
    ...
    public _loadFile(
      ...
      let request = Tools.LoadFile(
        ...
        onSuccess,
        onProgress,
        useDatabase ? this.database : undefined,
        useArrayBuffer,
        onError
      );
