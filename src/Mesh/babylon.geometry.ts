namespace BABYLON {
  export class Geometry implements IGetSetVerticesData {
    ...
    constructor(
      ...
      if (mesh) {
        if (mesh.getClassName() === "LinesMesh") {
          this.boundingBias = new Vector2(
            0,
            (<LinesMesh>mesh).intersectionThreshold
          );
          this.updateExtend();
        }
    ...
    public _bind(
      ...
      indexToBind?: Nullable<WebGLBuffer>
    ): void {
      if (!effect) {
        return;
      }
      ...
      if (!this._vertexArrayObjects[effect.key]) {
        this._vertexArrayObjects[
          effect.key
        ] = this._engine.recordVertexArrayObject(vbs, indexToBind, effect);
      }
    ...
    public updateIndices(indices: IndicesArray, offset?: number): void {
      ...
      if (!this._indexBufferIsUpdatable) {
        ...
        this._engine.updateDynamicIndexBuffer(
          this._indexBuffer,
          indices,
          offset
        );
    ...
    public setIndices(
      ...
      if (this._meshes.length !== 0 && this._indices) {
        this._indexBuffer = this._engine.createIndexBuffer(
          this._indices,
          updatable
        );
      }
    ...
    private updateExtend(data: Nullable<FloatArray> = null, stride?: number) {
      if (!data) {
        data = <FloatArray>this._vertexBuffers[
          VertexBuffer.PositionKind
        ].getData();
      }

      this._extend = Tools.ExtractMinAndMax(
        data,
        0,
        this._totalVertices,
        this.boundingBias,
    ...
    public static ImportGeometry(parsedGeometry: any, mesh: Mesh): void {
      ...
      if (geometryId) {
        ...
        if (
          binaryInfo.positionsAttrDesc &&
          binaryInfo.positionsAttrDesc.count > 0
        ) {
          var positionsData = new Float32Array(
            parsedGeometry,
            binaryInfo.positionsAttrDesc.offset,
            binaryInfo.positionsAttrDesc.count
          );
          mesh.setVerticesData(VertexBuffer.PositionKind, positionsData, false);
        }

        if (
          binaryInfo.normalsAttrDesc &&
          binaryInfo.normalsAttrDesc.count > 0
        ) {
          var normalsData = new Float32Array(
            parsedGeometry,
            binaryInfo.normalsAttrDesc.offset,
            binaryInfo.normalsAttrDesc.count
          );
        ...
        if (binaryInfo.uvsAttrDesc && binaryInfo.uvsAttrDesc.count > 0) {
          var uvsData = new Float32Array(
            parsedGeometry,
            binaryInfo.uvsAttrDesc.offset,
            binaryInfo.uvsAttrDesc.count
          );
          mesh.setVerticesData(VertexBuffer.UVKind, uvsData, false);
        }

        if (binaryInfo.uvs2AttrDesc && binaryInfo.uvs2AttrDesc.count > 0) {
          var uvs2Data = new Float32Array(
            parsedGeometry,
            binaryInfo.uvs2AttrDesc.offset,
            binaryInfo.uvs2AttrDesc.count
          );
          mesh.setVerticesData(VertexBuffer.UV2Kind, uvs2Data, false);
        }

        if (binaryInfo.uvs3AttrDesc && binaryInfo.uvs3AttrDesc.count > 0) {
          var uvs3Data = new Float32Array(
            parsedGeometry,
            binaryInfo.uvs3AttrDesc.offset,
            binaryInfo.uvs3AttrDesc.count
          );
          mesh.setVerticesData(VertexBuffer.UV3Kind, uvs3Data, false);
        }

        if (binaryInfo.uvs4AttrDesc && binaryInfo.uvs4AttrDesc.count > 0) {
          var uvs4Data = new Float32Array(
            parsedGeometry,
            binaryInfo.uvs4AttrDesc.offset,
            binaryInfo.uvs4AttrDesc.count
          );
          mesh.setVerticesData(VertexBuffer.UV4Kind, uvs4Data, false);
        }

        if (binaryInfo.uvs5AttrDesc && binaryInfo.uvs5AttrDesc.count > 0) {
          var uvs5Data = new Float32Array(
            parsedGeometry,
            binaryInfo.uvs5AttrDesc.offset,
            binaryInfo.uvs5AttrDesc.count
          );
          mesh.setVerticesData(VertexBuffer.UV5Kind, uvs5Data, false);
        }

        if (binaryInfo.uvs6AttrDesc && binaryInfo.uvs6AttrDesc.count > 0) {
          var uvs6Data = new Float32Array(
            parsedGeometry,
            binaryInfo.uvs6AttrDesc.offset,
            binaryInfo.uvs6AttrDesc.count
          );
          mesh.setVerticesData(VertexBuffer.UV6Kind, uvs6Data, false);
        }

        if (binaryInfo.colorsAttrDesc && binaryInfo.colorsAttrDesc.count > 0) {
          var colorsData = new Float32Array(
            parsedGeometry,
            binaryInfo.colorsAttrDesc.offset,
            binaryInfo.colorsAttrDesc.count
          );
          mesh.setVerticesData(
            VertexBuffer.ColorKind,
            colorsData,
            false,
            binaryInfo.colorsAttrDesc.stride
          );
        }

        if (
          binaryInfo.matricesIndicesAttrDesc &&
          binaryInfo.matricesIndicesAttrDesc.count > 0
        ) {
          var matricesIndicesData = new Int32Array(
            parsedGeometry,
            binaryInfo.matricesIndicesAttrDesc.offset,
            binaryInfo.matricesIndicesAttrDesc.count
          );
          mesh.setVerticesData(
        ...
        if (
          binaryInfo.matricesWeightsAttrDesc &&
          binaryInfo.matricesWeightsAttrDesc.count > 0
        ) {
          var matricesWeightsData = new Float32Array(
            parsedGeometry,
            binaryInfo.matricesWeightsAttrDesc.offset,
            binaryInfo.matricesWeightsAttrDesc.count
          );
          mesh.setVerticesData(
        ...
        if (
          binaryInfo.indicesAttrDesc &&
          binaryInfo.indicesAttrDesc.count > 0
        ) {
          var indicesData = new Int32Array(
            parsedGeometry,
            binaryInfo.indicesAttrDesc.offset,
            binaryInfo.indicesAttrDesc.count
          );
        ...
        if (
          ...
          binaryInfo.subMeshesAttrDesc.count > 0
        ) {
          var subMeshesData = new Int32Array(
            parsedGeometry,
            binaryInfo.subMeshesAttrDesc.offset,
            binaryInfo.subMeshesAttrDesc.count * 5
          );
        ...
        parsedGeometry.positions &&
        parsedGeometry.normals &&
        parsedGeometry.indices
      ) {
        mesh.setVerticesData(
          VertexBuffer.PositionKind,
          parsedGeometry.positions,
          parsedGeometry.positions._updatable
        );

        mesh.setVerticesData(
          VertexBuffer.NormalKind,
          parsedGeometry.normals,
          parsedGeometry.normals._updatable
        );
        ...
        if (parsedGeometry.uvs2) {
          mesh.setVerticesData(
            ...
            parsedGeometry.uvs2,
            parsedGeometry.uvs2._updatable
          );
        }
        ...
        if (parsedGeometry.uvs3) {
          mesh.setVerticesData(
            ...
            parsedGeometry.uvs3,
            parsedGeometry.uvs3._updatable
          );
        }
        ...
        if (parsedGeometry.uvs4) {
          mesh.setVerticesData(
            ...
            parsedGeometry.uvs4,
            parsedGeometry.uvs4._updatable
          );
        }
        ...
        if (parsedGeometry.uvs5) {
          mesh.setVerticesData(
            ...
            parsedGeometry.uvs5,
            parsedGeometry.uvs5._updatable
          );
        }
        ...
        if (parsedGeometry.uvs6) {
          mesh.setVerticesData(
            ...
            parsedGeometry.uvs6,
            parsedGeometry.uvs6._updatable
          );
        }
        ...
        if (parsedGeometry.colors) {
          mesh.setVerticesData(
            VertexBuffer.ColorKind,
            Color4.CheckColors4(
              parsedGeometry.colors,
              parsedGeometry.positions.length / 3
            ),
            parsedGeometry.colors._updatable
          );
        }
        ...
        if (parsedGeometry.matricesIndices) {
          if (!parsedGeometry.matricesIndices._isExpanded) {
            ...
            mesh.setVerticesData(
              VertexBuffer.MatricesIndicesKind,
              floatIndices,
              parsedGeometry.matricesIndices._updatable
            );
          } else {
        ...
        if (parsedGeometry.matricesIndicesExtra) {
          if (!parsedGeometry.matricesIndicesExtra._isExpanded) {
            ...
            for (
              var i = 0;
              i < parsedGeometry.matricesIndicesExtra.length;
              i++
            ) {
            ...
            mesh.setVerticesData(
              ...
              floatIndices,
              parsedGeometry.matricesIndicesExtra._updatable
            );
          } else {
            delete parsedGeometry.matricesIndices._isExpanded;
            mesh.setVerticesData(
        ...
        if (parsedGeometry.matricesWeights) {
          ...
          mesh.setVerticesData(
            VertexBuffer.MatricesWeightsKind,
            parsedGeometry.matricesWeights,
            parsedGeometry.matricesWeights._updatable
          );
        }
        ...
        if (parsedGeometry.matricesWeightsExtra) {
          mesh.setVerticesData(
            ...
            parsedGeometry.matricesWeightsExtra,
            parsedGeometry.matricesWeights._updatable
          );
        }
      ...
      if (parsedGeometry.subMeshes) {
        ...
        for (
          var subIndex = 0;
          subIndex < parsedGeometry.subMeshes.length;
          subIndex++
        ) {
    ...
    private static _CleanMatricesWeights(
      ...
      if (parsedGeometry.skeletonId > -1) {
        let skeleton = mesh
          .getScene()
          .getLastSkeletonByID(parsedGeometry.skeletonId);
      ...
      let matricesIndices = <FloatArray>mesh.getVerticesData(
        VertexBuffer.MatricesIndicesKind
      );
      let matricesIndicesExtra = <FloatArray>mesh.getVerticesData(
        VertexBuffer.MatricesIndicesExtraKind
      );
  ...
  export class _PrimitiveGeometry extends Geometry {
    ...
    constructor(
      id: string,
      scene: Scene,
      private _canBeRegenerated: boolean = false,
      mesh: Nullable<Mesh> = null
    ) {
  ...
  export class RibbonGeometry extends _PrimitiveGeometry {
    ...
    public _regenerateVertexData(): VertexData {
      return VertexData.CreateRibbon({
  ...
  export class SphereGeometry extends _PrimitiveGeometry {
    ...
    public static Parse(
      ...
      var sphere = new SphereGeometry(
        parsedSphere.id,
        scene,
        parsedSphere.segments,
        parsedSphere.diameter,
        parsedSphere.canBeRegenerated,
        null
      );
      if (Tags) {
  ...
  export class CylinderGeometry extends _PrimitiveGeometry {
    ...
    public _regenerateVertexData(): VertexData {
      return VertexData.CreateCylinder({
        height: this.height,
    ...
    public static Parse(
      ...
      var cylinder = new CylinderGeometry(
        parsedCylinder.id,
        scene,
        parsedCylinder.height,
        parsedCylinder.diameterTop,
        parsedCylinder.diameterBottom,
        parsedCylinder.tessellation,
        parsedCylinder.subdivisions,
        parsedCylinder.canBeRegenerated,
        null
      );
      if (Tags) {
  ...
  export class TorusGeometry extends _PrimitiveGeometry {
    ...
    public static Parse(
      parsedTorus: any,
      scene: Scene
    ): Nullable<TorusGeometry> {
      if (scene.getGeometryByID(parsedTorus.id)) {
        return null; // null since geometry could be something else than a torus...
      }

      var torus = new TorusGeometry(
        parsedTorus.id,
        scene,
        parsedTorus.diameter,
        parsedTorus.thickness,
        parsedTorus.tessellation,
        parsedTorus.canBeRegenerated,
        null
      );
      if (Tags) {
  ...
  export class GroundGeometry extends _PrimitiveGeometry {
    ...
    public _regenerateVertexData(): VertexData {
      return VertexData.CreateGround({
        width: this.width,
        height: this.height,
        subdivisions: this.subdivisions
      });
  ...
  export class TiledGroundGeometry extends _PrimitiveGeometry {
    ...
    public _regenerateVertexData(): VertexData {
      return VertexData.CreateTiledGround({
        xmin: this.xmin,
        zmin: this.zmin,
        xmax: this.xmax,
        zmax: this.zmax,
    ...
    public copy(id: string): Geometry {
      return new TiledGroundGeometry(
        id,
        this.getScene(),
        this.xmin,
        this.zmin,
  ...
  export class TorusKnotGeometry extends _PrimitiveGeometry {
    ...
    public _regenerateVertexData(): VertexData {
      return VertexData.CreateTorusKnot({
        radius: this.radius,
        tube: this.tube,
    ...
    public static Parse(
      parsedTorusKnot: any,
      scene: Scene
    ): Nullable<TorusKnotGeometry> {
      if (scene.getGeometryByID(parsedTorusKnot.id)) {
        return null; // null since geometry could be something else than a ground...
      }

      var torusKnot = new TorusKnotGeometry(
        parsedTorusKnot.id,
        scene,
        parsedTorusKnot.radius,
        parsedTorusKnot.tube,
        parsedTorusKnot.radialSegments,
        parsedTorusKnot.tubularSegments,
        parsedTorusKnot.p,
        parsedTorusKnot.q,
        parsedTorusKnot.canBeRegenerated,
        null
      );
      if (Tags) {
