namespace BABYLON {
  ...
  export class VertexData {
    ...
    private _applyTo(
      ...
      if (this.positions) {
        meshOrGeometry.setVerticesData(
    ...
    private _update(
      ...
      if (this.positions) {
        meshOrGeometry.updateVerticesData(
          VertexBuffer.PositionKind,
          this.positions,
          updateExtends,
          makeItUnique
    ...
    public merge(
      ...
      this.tangents = this._mergeElement(
        this.tangents,
        other.tangents,
        count * (options.tangentLength || 4)
      );
      ...
      this.matricesIndices = this._mergeElement(
        this.matricesIndices,
        other.matricesIndices,
        count * 4
      );
      this.matricesWeights = this._mergeElement(
        this.matricesWeights,
        other.matricesWeights,
        count * 4
      );
      this.matricesIndicesExtra = this._mergeElement(
        this.matricesIndicesExtra,
        other.matricesIndicesExtra,
        count * 4
      );
      this.matricesWeightsExtra = this._mergeElement(
        this.matricesWeightsExtra,
     ...
     */
    public static ExtractFromGeometry(
      geometry: Geometry,
      copyWhenShared?: boolean,
      forceCopy?: boolean
    ): VertexData {
    ...
    private static _ExtractFrom(
      ...
      if (meshOrGeometry.isVerticesDataPresent(VertexBuffer.UVKind)) {
        result.uvs = meshOrGeometry.getVerticesData(
          VertexBuffer.UVKind,
          copyWhenShared,
          forceCopy
        );
      ...
      if (meshOrGeometry.isVerticesDataPresent(VertexBuffer.UV2Kind)) {
        result.uvs2 = meshOrGeometry.getVerticesData(
          VertexBuffer.UV2Kind,
          copyWhenShared,
          forceCopy
        );
      ...
      if (meshOrGeometry.isVerticesDataPresent(VertexBuffer.UV3Kind)) {
        result.uvs3 = meshOrGeometry.getVerticesData(
          VertexBuffer.UV3Kind,
          copyWhenShared,
          forceCopy
        );
      ...
      if (meshOrGeometry.isVerticesDataPresent(VertexBuffer.UV4Kind)) {
        result.uvs4 = meshOrGeometry.getVerticesData(
          VertexBuffer.UV4Kind,
          copyWhenShared,
          forceCopy
        );
      ...
      if (meshOrGeometry.isVerticesDataPresent(VertexBuffer.UV5Kind)) {
        result.uvs5 = meshOrGeometry.getVerticesData(
          VertexBuffer.UV5Kind,
          copyWhenShared,
          forceCopy
        );
      ...
      if (meshOrGeometry.isVerticesDataPresent(VertexBuffer.UV6Kind)) {
        result.uvs6 = meshOrGeometry.getVerticesData(
          VertexBuffer.UV6Kind,
          copyWhenShared,
          forceCopy
        );
      ...
      if (meshOrGeometry.isVerticesDataPresent(VertexBuffer.ColorKind)) {
        result.colors = meshOrGeometry.getVerticesData(
          VertexBuffer.ColorKind,
          copyWhenShared,
          forceCopy
        );
      ...
      if (
        meshOrGeometry.isVerticesDataPresent(VertexBuffer.MatricesIndicesKind)
      ) {
      ...
      if (
        meshOrGeometry.isVerticesDataPresent(VertexBuffer.MatricesWeightsKind)
      ) {
      ...
      if (
        meshOrGeometry.isVerticesDataPresent(
          VertexBuffer.MatricesIndicesExtraKind
        )
      ) {
    ...
    public static CreateBox(options: {
      ...
      if (faceColors) {
        var totalColors =
          sideOrientation === Mesh.DOUBLESIDE ? colors.concat(colors) : colors;
    ...
    public static CreateSphere(options: {
      ...
      var arc: number =
        options.arc && (options.arc <= 0 || options.arc > 1)
          ...
          : options.arc || 1.0;
      var slice: number =
        options.slice && options.slice <= 0 ? 1.0 : options.slice || 1.0;
      var sideOrientation =
        options.sideOrientation === 0
          ? 0
          : options.sideOrientation || Mesh.DEFAULTSIDE;
    ...
    public static CreateCylinder(options: {
      ...
      var diameterTop: number =
        options.diameterTop === 0
          ? 0
          : options.diameterTop || options.diameter || 1;
      var diameterBottom: number =
        options.diameterBottom === 0
          ? 0
          : options.diameterBottom || options.diameter || 1;
        ...
        for (r = 0; r < ringIdx; r++) {
          ...
          for (j = 0; j <= tessellation; j++) {
            ...
            if (diameterTop === 0 && i === subdivisions) {
              ...
              ringNormal.y =
                normals[normals.length - (tessellation + 1) * 3 + 1];
              ringNormal.z =
                normals[normals.length - (tessellation + 1) * 3 + 2];
            } else {
              ringNormal.x = ringVertex.x;
              ringNormal.z = ringVertex.z;
              ringNormal.y =
                Math.sqrt(
                  ringNormal.x * ringNormal.x + ringNormal.z * ringNormal.z
                ) * tan;
            ...
            uvs.push(
              faceUV[s].x + (faceUV[s].z - faceUV[s].x) * j / tessellation,
              v
            );
            if (faceColors) {
              colors.push(
      ...
      var createCylinderCap = (isTop: boolean) => {
        ...
        for (i = 0; i <= tessellation; i++) {
          ...
          var textureCoordinate = new Vector2(
            cos * textureScale.x + 0.5,
            sin * textureScale.y + 0.5
          );
    ...
    public static CreateTorus(options: {
      ...
      for (var i = 0; i <= tessellation; i++) {
        ...
        var transform = Matrix.Translation(diameter / 2.0, 0, 0).multiply(
     ...
     */
    public static CreateLineSystem(options: {
      lines: Vector3[][];
     ...
     */
    public static CreateDashedLines(options: {
      points: Vector3[];
      dashSize?: number;
      gapSize?: number;
      dashNb?: number;
     ...
     */
    public static CreateGround(options: {
      width?: number;
      height?: number;
      subdivisions?: number;
      ...
      var subdivisionsX: number =
        options.subdivisionsX || options.subdivisions || 1;
      var subdivisionsY: number =
        options.subdivisionsY || options.subdivisions || 1;
      ...
      for (row = 0; row <= subdivisionsY; row++) {
        for (col = 0; col <= subdivisionsX; col++) {
          var position = new Vector3(
            ...
            0,
            (subdivisionsY - row) * height / subdivisionsY - height / 2.0
          );
    ...
    public static CreateTiledGround(options: {
      ...
      var xmin =
        options.xmin !== undefined && options.xmin !== null
          ? options.xmin
          : -1.0;
      var zmin =
        options.zmin !== undefined && options.zmin !== null
          ? options.zmin
          : -1.0;
      var xmax =
        options.xmax !== undefined && options.xmax !== null
          ? options.xmax
          : 1.0;
      var zmax =
        options.zmax !== undefined && options.zmax !== null
          ? options.zmax
          : 1.0;
    ...
    public static CreateGroundFromHeightMap(options: {
      ...
      for (row = 0; row <= options.subdivisions; row++) {
        for (col = 0; col <= options.subdivisions; col++) {
          ...
          position.y =
            options.minHeight +
            (options.maxHeight - options.minHeight) * gradient;

          // Add  vertex
          positions.push(position.x, position.y, position.z);
          normals.push(0, 0, 0);
          uvs.push(
            col / options.subdivisions,
            1.0 - row / options.subdivisions
          );
        }
      }
     ...
     */
    public static CreateDisc(options: {
      radius?: number;
      tessellation?: number;
      arc?: number;
      sideOrientation?: number;
    ...
    public static CreatePolygon(
      ...
      var positions = <FloatArray>polygon.getVerticesData(
        VertexBuffer.PositionKind
      );
      var normals = <FloatArray>polygon.getVerticesData(
        VertexBuffer.NormalKind
      );
      ...
      for (var face = 0; face < 20; face++) {
        ...
        for (v012 = 0; v012 < 3; v012++) {
          ...
          face_vertex_uv[v012].copyFromFloats(
            ico_vertexuv[2 * v_id] * ustep +
              uoffset +
              island[face] * island_u_offset,
            ico_vertexuv[2 * v_id + 1] * vstep +
              voffset +
        ...
        var interp_vertex = (
          ...
          //   - face_vertex_pos[0..2]
          //   - face_vertex_uv[0..2]
          var pos_x0 = Vector3.Lerp(
            face_vertex_pos[0],
            face_vertex_pos[2],
            i2 / subdivisions
          );
          var pos_x1 = Vector3.Lerp(
            face_vertex_pos[1],
            face_vertex_pos[2],
            i2 / subdivisions
          );
          var pos_interp =
            subdivisions === i2
              ? face_vertex_pos[2]
              : Vector3.Lerp(pos_x0, pos_x1, i1 / (subdivisions - i2));
          pos_interp.normalize();

          var vertex_normal;
          if (flat) {
            // in flat mode, recalculate normal as face centroid normal
            var centroid_x0 = Vector3.Lerp(
              face_vertex_pos[0],
              face_vertex_pos[2],
              c2 / subdivisions
            );
            var centroid_x1 = Vector3.Lerp(
              face_vertex_pos[1],
              face_vertex_pos[2],
              c2 / subdivisions
            );
            vertex_normal = Vector3.Lerp(
              centroid_x0,
              centroid_x1,
              c1 / (subdivisions - c2)
            );
          ...
          var uv_x0 = Vector2.Lerp(
            face_vertex_uv[0],
            face_vertex_uv[2],
            i2 / subdivisions
          );
          var uv_x1 = Vector2.Lerp(
            face_vertex_uv[1],
            face_vertex_uv[2],
            i2 / subdivisions
          );
          var uv_interp =
            subdivisions === i2
              ? face_vertex_uv[2]
              : Vector2.Lerp(uv_x0, uv_x1, i1 / (subdivisions - i2));
          positions.push(
    ...
    public static CreatePolyhedron(options: {
      ...
      var type: number =
        options.type && (options.type < 0 || options.type >= polyhedra.length)
          ? 0
          : options.type || 0;
      ...
      if (!flat) {
        for (i = 0; i < data.vertex.length; i++) {
          positions.push(
            data.vertex[i][0] * sizeX,
            data.vertex[i][1] * sizeY,
            data.vertex[i][2] * sizeZ
          );
          uvs.push(0, 0);
        }
        for (f = 0; f < nbfaces; f++) {
        ...
        for (f = 0; f < nbfaces; f++) {
          ...
          for (i = 0; i < fl; i++) {
            // positions
            positions.push(
              data.vertex[data.face[f][i]][0] * sizeX,
              data.vertex[data.face[f][i]][1] * sizeY,
              data.vertex[data.face[f][i]][2] * sizeZ
            );
            indexes.push(index);
            index++;
            // uvs
    ...
    public static ComputeNormals(
      ...
      if (computeFacetPartitioning && options && options.bbSize) {
        ...
        var bbSizeMax =
          options.bbSize.x > options.bbSize.y
            ? options.bbSize.x
            : options.bbSize.y;
      ...
      for (index = 0; index < nbFaces; index++) {
        ...
        if (computeFacetPositions && options) {
          ...
          options.facetPositions[index].x =
            (positions[v1x] + positions[v2x] + positions[v3x]) / 3.0;
          options.facetPositions[index].y =
            (positions[v1y] + positions[v2y] + positions[v3y]) / 3.0;
          options.facetPositions[index].z =
            (positions[v1z] + positions[v2z] + positions[v3z]) / 3.0;
        }
        ...
        if (computeFacetPartitioning && options) {
          ...
          ox = Math.floor(
            (options.facetPositions[index].x -
              options.bInfo.minimum.x * ratio) *
              xSubRatio
          );
          oy = Math.floor(
            (options.facetPositions[index].y -
              options.bInfo.minimum.y * ratio) *
              ySubRatio
          );
          oz = Math.floor(
            (options.facetPositions[index].z -
              options.bInfo.minimum.z * ratio) *
              zSubRatio
          );
          b1x = Math.floor(
          ...
          options.facetPartitioning[block_idx_o] = options.facetPartitioning[
            block_idx_o
          ]
            ? options.facetPartitioning[block_idx_o]
            : new Array();
          options.facetPartitioning[block_idx_v1] = options.facetPartitioning[
            block_idx_v1
          ]
            ? options.facetPartitioning[block_idx_v1]
            : new Array();
          options.facetPartitioning[block_idx_v2] = options.facetPartitioning[
            block_idx_v2
          ]
            ? options.facetPartitioning[block_idx_v2]
            : new Array();
          options.facetPartitioning[block_idx_v3] = options.facetPartitioning[
            block_idx_v3
          ]
          ...
          if (
            !(
              block_idx_o == block_idx_v1 ||
              block_idx_o == block_idx_v2 ||
        ...
        if (computeDepthSort && options && options.facetPositions) {
          ...
          dsf.ind = index * 3;
          dsf.sqDistance = Vector3.DistanceSquared(
            options.facetPositions[index],
            distanceTo!
          );
        }
    ...
    public static ImportVertexData(parsedVertexData: any, geometry: Geometry) {
      ...
      if (colors) {
        vertexData.set(
          Color4.CheckColors4(colors, positions.length / 3),
          VertexBuffer.ColorKind
        );
      }
