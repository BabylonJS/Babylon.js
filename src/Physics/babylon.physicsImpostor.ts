namespace BABYLON {
  ...
  export class PhysicsImpostor {
    ...
    private _onBeforePhysicsStepCallbacks = new Array<
      (impostor: PhysicsImpostor) => void
    >();
    private _onAfterPhysicsStepCallbacks = new Array<
      (impostor: PhysicsImpostor) => void
    >();
    private _onPhysicsCollideCallbacks: Array<{
      callback: (
    ...
    private static _tmpVecs: Vector3[] = [
      Vector3.Zero(),
      Vector3.Zero(),
      Vector3.Zero()
    ];
      ...
      if (!this._physicsEngine) {
        ...
        if (!this.object.rotationQuaternion) {
          if (this.object.rotation) {
            this.object.rotationQuaternion = Quaternion.RotationYawPitchRoll(
        ...
        this._options.friction =
          _options.friction === void 0 ? 0.2 : _options.friction;
        this._options.restitution =
          _options.restitution === void 0 ? 0.2 : _options.restitution;
    ...
    public setLinearVelocity(velocity: Nullable<Vector3>) {
      if (this._physicsEngine) {
        this._physicsEngine
          .getPhysicsPlugin()
          .setLinearVelocity(this, velocity);
      }
    }
    ...
    public setAngularVelocity(velocity: Nullable<Vector3>) {
      if (this._physicsEngine) {
        this._physicsEngine
          .getPhysicsPlugin()
          .setAngularVelocity(this, velocity);
      }
    }
     ...
     */
    public registerBeforePhysicsStep(
      func: (impostor: PhysicsImpostor) => void
    ): void {
      this._onBeforePhysicsStepCallbacks.push(func);
    }

    public unregisterBeforePhysicsStep(
      func: (impostor: PhysicsImpostor) => void
    ): void {
     ...
     */
    public registerAfterPhysicsStep(
      func: (impostor: PhysicsImpostor) => void
    ): void {
      this._onAfterPhysicsStepCallbacks.push(func);
    }

    public unregisterAfterPhysicsStep(
      func: (impostor: PhysicsImpostor) => void
    ): void {
    ...
    public registerOnPhysicsCollide(
      ...
      var collidedAgainstList: Array<PhysicsImpostor> =
        collideAgainst instanceof Array
    ...
    public beforeStep = () => {
      ...
      this._deltaRotationConjugated &&
        ...
        this.object.rotationQuaternion.multiplyToRef(
          this._deltaRotationConjugated,
          this.object.rotationQuaternion
        );
      ...
      if (this.object.parent && this.object.rotationQuaternion) {
        ...
        this._tmpQuat.multiplyToRef(
          this.object.rotationQuaternion,
          this._tmpQuat
        );
      } else {
        this._tmpQuat.copyFrom(
          this.object.rotationQuaternion || new Quaternion()
        );
      }
        ...
        this.object.rotationQuaternion &&
          this._physicsEngine
            ...
            .setPhysicsBodyTransformation(
              this,
              /*bInfo.boundingBox.centerWorld*/ this.object.getAbsolutePivotPoint(),
              this._tmpQuat
            );
      }
    ...
    public afterStep = () => {
      ...
      this._physicsEngine
        .getPhysicsPlugin()
        .setTransformationFromPhysicsBody(this);
     ...
     */
    public onCollideEvent: Nullable<
      (collider: PhysicsImpostor, collidedWith: PhysicsImpostor) => void
    > = null;
    ...
    public onCollide = (e: { body: any }) => {
      ...
      var otherImpostor = this._physicsEngine.getImpostorWithPhysicsBody(
        e.body
      );
      if (otherImpostor) {
        // Legacy collision detection event support
        ...
        this._onPhysicsCollideCallbacks
          .filter(obj => {
            return (
              obj.otherImpostors.indexOf(<PhysicsImpostor>otherImpostor) !== -1
            );
          })
          .forEach(obj => {
    ...
    public applyForce(force: Vector3, contactPoint: Vector3): PhysicsImpostor {
      if (this._physicsEngine) {
        this._physicsEngine
          .getPhysicsPlugin()
          .applyForce(this, force, contactPoint);
      }
      return this;
    }
    ...
    public applyImpulse(
      ...
      if (this._physicsEngine) {
        this._physicsEngine
          .getPhysicsPlugin()
          .applyImpulse(this, force, contactPoint);
      }
