namespace BABYLON {
  ...
  export class CannonJSPlugin implements IPhysicsEnginePlugin {
    ...
    public BJSCANNON = typeof CANNON !== "undefined"
      ? CANNON
      : typeof require !== "undefined" ? require("cannon") : undefined;
    ...
    public executeStep(delta: number, impostors: Array<PhysicsImpostor>): void {
      this.world.step(
        this._fixedTimeStep,
        this._useDeltaForWorldStep ? delta : 0,
        3
      );
    }
    ...
    public applyImpulse(
      ...
      var worldPoint = new this.BJSCANNON.Vec3(
        contactPoint.x,
        contactPoint.y,
        contactPoint.z
      );
    ...
    public generatePhysicsBody(impostor: PhysicsImpostor) {
      ...
      if (impostor.isBodyInitRequired()) {
        ...
        var material = this._addMaterial(
          "mat-" + impostor.uniqueId,
        ...
        //Should be tested!
        if (oldBody) {
          ["force", "torque", "velocity", "angularVelocity"].forEach(function(
            param
          ) {
    ...
    private _processChildMeshes(mainImpostor: PhysicsImpostor) {
      var meshChildren = mainImpostor.object.getChildMeshes
        ? mainImpostor.object.getChildMeshes(true)
        : [];
      let currentRotation: Nullable<Quaternion> =
        mainImpostor.object.rotationQuaternion;
      if (meshChildren.length) {
        var processMesh = (localPosition: Vector3, mesh: AbstractMesh) => {
          ...
          if (childImpostor) {
            ...
            if (parent !== mainImpostor) {
              var pPosition = mesh
                .getAbsolutePosition()
                .subtract(mainImpostor.object.getAbsolutePosition());
              let localRotation = mesh.rotationQuaternion.multiply(
        ...
        meshChildren
          .filter(m => !!m.physicsImpostor)
          .forEach(
            processMesh.bind(this, mainImpostor.object.getAbsolutePosition())
          );
      }
    }
    ...
    public generateJoint(impostorJoint: PhysicsImpostorJoint) {
      ...
      var constraintData = {
        pivotA: jointData.mainPivot
          ? new this.BJSCANNON.Vec3().copy(jointData.mainPivot)
          : null,
        pivotB: jointData.connectedPivot
          ? new this.BJSCANNON.Vec3().copy(jointData.connectedPivot)
          : null,
        axisA: jointData.mainAxis
          ? new this.BJSCANNON.Vec3().copy(jointData.mainAxis)
          : null,
        axisB: jointData.connectedAxis
          ? new this.BJSCANNON.Vec3().copy(jointData.connectedAxis)
          : null,
      ...
      switch (impostorJoint.joint.type) {
        ...
        case PhysicsJoint.Hinge2Joint:
          constraint = new this.BJSCANNON.HingeConstraint(
            mainBody,
            connectedBody,
            constraintData
          );
        ...
        case PhysicsJoint.DistanceJoint:
          constraint = new this.BJSCANNON.DistanceConstraint(
            mainBody,
            connectedBody,
            (<DistanceJointData>jointData).maxDistance || 2
          );
          break;
        ...
        case PhysicsJoint.LockJoint:
          constraint = new this.BJSCANNON.LockConstraint(
            mainBody,
            connectedBody,
            constraintData
          );
        ...
        default:
          constraint = new this.BJSCANNON.PointToPointConstraint(
            mainBody,
            constraintData.pivotA,
            connectedBody,
            constraintData.pivotA,
            constraintData.maxForce
          );
          break;
      }
    ...
    private _createShape(impostor: PhysicsImpostor) {
      ...
      switch (impostor.type) {
        case PhysicsImpostor.SphereImpostor:
          ...
          returnValue = new this.BJSCANNON.Sphere(
            Math.max(
              this._checkWithEpsilon(radiusX),
              this._checkWithEpsilon(radiusY),
              this._checkWithEpsilon(radiusZ)
            ) / 2
          );
        ...
        case PhysicsImpostor.CylinderImpostor:
          returnValue = new this.BJSCANNON.Cylinder(
            this._checkWithEpsilon(extendSize.x) / 2,
            this._checkWithEpsilon(extendSize.x) / 2,
            this._checkWithEpsilon(extendSize.y),
            16
          );
          break;
        case PhysicsImpostor.BoxImpostor:
          var box = extendSize.scale(0.5);
          returnValue = new this.BJSCANNON.Box(
            new this.BJSCANNON.Vec3(
              this._checkWithEpsilon(box.x),
              this._checkWithEpsilon(box.y),
              this._checkWithEpsilon(box.z)
            )
          );
          break;
        ...
        case PhysicsImpostor.MeshImpostor:
          ...
          var rawVerts = object.getVerticesData
            ? object.getVerticesData(VertexBuffer.PositionKind)
            : [];
          ...
          let oldQuaternion =
            object.rotationQuaternion && object.rotationQuaternion.clone();
          object.position.copyFromFloats(0, 0, 0);
          object.rotation && object.rotation.copyFromFloats(0, 0, 0);
          object.rotationQuaternion &&
            object.rotationQuaternion.copyFrom(impostor.getParentsRotation());

          object.rotationQuaternion &&
            object.parent &&
            object.rotationQuaternion.conjugateInPlace();
          ...
          for (index = 0; index < rawVerts.length; index += 3) {
            Vector3.TransformCoordinates(
              Vector3.FromArray(rawVerts, index),
              transform
            ).toArray(temp, index);
          }
          ...
          oldRotation &&
            object.rotation &&
            object.rotation.copyFrom(oldRotation);
          oldQuaternion &&
            object.rotationQuaternion &&
            object.rotationQuaternion.copyFrom(oldQuaternion);
          break;
        case PhysicsImpostor.HeightmapImpostor:
          ...
          object.rotationQuaternion &&
            ...
            object.rotationQuaternion.conjugateInPlace();
          object.rotationQuaternion &&
            object.rotationQuaternion.multiplyInPlace(this._minus90X);

          returnValue = this._createHeightmap(object);
          object.position.copyFrom(oldPosition2);
          oldRotation2 &&
            object.rotation &&
            object.rotation.copyFrom(oldRotation2);
          oldQuaternion2 &&
            object.rotationQuaternion &&
            object.rotationQuaternion.copyFrom(oldQuaternion2);
    ...
    private _minus90X = new Quaternion(
      -0.7071067811865475,
      0,
      0,
      0.7071067811865475
    );
    private _plus90X = new Quaternion(
      0.7071067811865475,
      0,
      0,
      0.7071067811865475
    ...
    private _updatePhysicsBodyTransformation(impostor: PhysicsImpostor) {
      ...
      this._tmpDeltaPosition.copyFrom(
        object.getAbsolutePivotPoint().subtract(center)
      );
      ...
      if (
        impostor.type === PhysicsImpostor.PlaneImpostor ||
        impostor.type === PhysicsImpostor.HeightmapImpostor ||
        impostor.type === PhysicsImpostor.CylinderImpostor
      ) {
      ...
      if (impostor.type === PhysicsImpostor.HeightmapImpostor) {
        ...
        var translation = boundingInfo.boundingBox.centerWorld
          .subtract(center)
        ...
        this._tmpPosition.copyFromFloats(
          translation.x,
          translation.y - boundingInfo.boundingBox.extendSizeWorld.y,
          translation.z
        );
        //add it inverted to the delta
        this._tmpDeltaPosition.copyFrom(
          boundingInfo.boundingBox.centerWorld.subtract(c)
        );
    ...
    public setTransformationFromPhysicsBody(impostor: PhysicsImpostor) {
      ...
      if (impostor.object.rotationQuaternion) {
        impostor.object.rotationQuaternion.copyFrom(
          impostor.physicsBody.quaternion
        );
      }
    }
    ...
    public setLimit(
      ...
      joint.physicsJoint.motorEquation.minForce =
        lowerLimit === void 0 ? -upperLimit : lowerLimit;
    }
    ...
    private _extendNamespace() {
      ...
      this.BJSCANNON.World.prototype.step = function(
        dt: number,
        ...
        if (timeSinceLastCalled === 0) {
          ...
          for (var j = 0; j !== bodies.length; j++) {
            ...
            if (
              ...
              b.sleepState !== Engine.Body.SLEEPING
            ) {
