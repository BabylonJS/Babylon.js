  ...
  export class BoundingInfo implements ICullable {
    ...
    public _checkCollision(collider: Collider): boolean {
      return collider._canDoCollision(
        this.boundingSphere.centerWorld,
        this.boundingSphere.radiusWorld,
        this.boundingBox.minimumWorld,
        this.boundingBox.maximumWorld
      );
    }
    ...
    public intersects(boundingInfo: BoundingInfo, precise: boolean): boolean {
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[0], box1.directions[0]),
          box0,
          box1
        )
      )
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[0], box1.directions[1]),
          box0,
          box1
        )
      )
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[0], box1.directions[2]),
          box0,
          box1
        )
      )
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[1], box1.directions[0]),
          box0,
          box1
        )
      )
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[1], box1.directions[1]),
          box0,
          box1
        )
      )
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[1], box1.directions[2]),
          box0,
          box1
        )
      )
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[2], box1.directions[0]),
          box0,
          box1
        )
      )
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[2], box1.directions[1]),
          box0,
          box1
        )
      )
      ...
      if (
        !axisOverlap(
          Vector3.Cross(box0.directions[2], box1.directions[2]),
          box0,
          box1
        )
      )
