namespace BABYLON {
  export class Ray {
    ...
    private _comparePickingInfo(
      pickingInfoA: PickingInfo,
      pickingInfoB: PickingInfo
    ): number {
    ...
    intersectionSegment(
      ...
      var rsegb = this.origin.add(
        this.direction.multiplyByFloats(Ray.rayl, Ray.rayl, Ray.rayl)
      );
