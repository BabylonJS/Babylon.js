namespace BABYLON {
  export class _AlphaState {
    ...
    public setAlphaBlendFunctionParameters(
      value0: number,
      value1: number,
      value2: number,
      value3: number
    ...
    public apply(gl: WebGLRenderingContext) {
      ...
      if (this._isBlendEquationParametersDirty) {
        gl.blendEquationSeparate(
          (<any>this._isBlendEquationParametersDirty)[0],
          (<any>this._isBlendEquationParametersDirty)[1]
        );
        this._isBlendEquationParametersDirty = false;
      }
      ...
      if (this._isBlendConstantsDirty) {
        gl.blendColor(
          <number>this._blendConstants[0],
          <number>this._blendConstants[1],
          <number>this._blendConstants[2],
          <number>this._blendConstants[3]
        );
        this._isBlendConstantsDirty = false;
      }
    }
