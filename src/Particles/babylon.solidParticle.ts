namespace BABYLON {
  ...
  export class SolidParticle {
    ...
    public intersectsMesh(target: Mesh | SolidParticle): boolean {
      ...
      if (this._sps._bSphereOnly) {
        return BoundingSphere.Intersects(
  ...
  export class ModelShape {
     ...
     */
    public _positionFunction: Nullable<
      (particle: SolidParticle, i: number, s: number) => void
    >;
    /**
     * Custom vertex function (internal use)
     */
    public _vertexFunction: Nullable<
      (particle: SolidParticle, vertex: Vector3, i: number) => void
    >;
