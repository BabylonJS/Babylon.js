namespace BABYLON {
  export class PostProcessManager {
    ...
    // Methods
    public _prepareFrame(
      sourceTexture: Nullable<InternalTexture> = null,
      postProcesses: Nullable<PostProcess[]> = null
    ): boolean {
      ...
      var postProcesses =
        postProcesses || <Nullable<PostProcess[]>>camera._postProcesses;
      ...
      postProcesses[0].activate(
        camera,
        sourceTexture,
        postProcesses !== null && postProcesses !== undefined
      );
      return true;
    }
    ...
    public directRender(
      ...
      targetTexture: Nullable<InternalTexture> = null,
