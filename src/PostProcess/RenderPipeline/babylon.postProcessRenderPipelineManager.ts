namespace BABYLON {
  export class PostProcessRenderPipelineManager {
    ...
    public attachCamerasToRenderPipeline(
    ...
    public attachCamerasToRenderPipeline(
      ...
      var renderPipeline: PostProcessRenderPipeline = this._renderPipelines[
        renderPipelineName
      ];
    ...
    public detachCamerasFromRenderPipeline(
      renderPipelineName: string,
      cameras: Camera
    ): void;
    public detachCamerasFromRenderPipeline(
    ...
    public disableEffectInPipeline(
      renderPipelineName: string,
      renderEffectName: string,
      cameras: Camera
    ): void;
    ...
    public enableDisplayOnlyPassInPipeline(
      renderPipelineName: string,
      passName: string,
      cameras: Camera
    ): void;
    ...
    public disableDisplayOnlyPassInPipeline(
      renderPipelineName: string,
      cameras: Camera
    ): void;
    public disableDisplayOnlyPassInPipeline(
