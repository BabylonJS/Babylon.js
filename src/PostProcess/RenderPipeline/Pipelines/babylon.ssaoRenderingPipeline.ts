namespace BABYLON {
  export class SSAORenderingPipeline extends PostProcessRenderPipeline {
     ...
     * @type {number}
     */
    @serialize() public radius: number = 0.0001;
     ...
     * @type {number}
     */
    @serialize() public area: number = 0.0075;
     ...
     * @type {number}
     */
    @serialize() public fallOff: number = 0.000001;
     ...
     * @type {number}
     */
    @serialize() public base: number = 0.5;
