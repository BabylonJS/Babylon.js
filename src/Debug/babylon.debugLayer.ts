namespace BABYLON {
  ...
  export class DebugLayer {
    ...
    private BJSINSPECTOR = typeof INSPECTOR !== "undefined"
      ? INSPECTOR
      : undefined;
    ...
    private _createInspector(
      ...
      if (!this._inspector) {
        this.BJSINSPECTOR =
          this.BJSINSPECTOR || typeof INSPECTOR !== "undefined"
            ? INSPECTOR
            : undefined;

        this._inspector = new this.BJSINSPECTOR.Inspector(
          this._scene,
          popup,
          initialTab,
          parentElement,
    ...
    public show(
      ...
      if (typeof this.BJSINSPECTOR == "undefined") {
        ...
        Tools.LoadScript(
          ...
          this._createInspector.bind(this, config)
        );
      } else {
