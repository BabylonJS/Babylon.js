    ...
    public static PhysicsViewer = class PhysicsViewer {
      ...
      _getDebugBoxMesh(scene: Scene): AbstractMesh {
        if (!this._debugBoxMesh) {
          this._debugBoxMesh = MeshBuilder.CreateBox(
      ...
      _getDebugSphereMesh(scene: Scene): AbstractMesh {
        if (!this._debugSphereMesh) {
          this._debugSphereMesh = MeshBuilder.CreateSphere(
        ...
        return this._debugSphereMesh.createInstance(
          "physicsBodyBoxViewInstance"
        );
      }
    ...
    public static SkeletonViewer = class SkeletonViewer {
      ...
      public update() {
        ...
        if (this.skeleton.bones[0].length === undefined) {
          ...
          this._getLinesForBonesWithLength(
            this.skeleton.bones,
            this.mesh.getWorldMatrix()
          );
        }
        ...
        if (!this._debugMesh) {
          this._debugMesh = BABYLON.MeshBuilder.CreateLineSystem(
            "",
            { lines: this._debugLines, updatable: true, instance: null },
            this._scene
          );
