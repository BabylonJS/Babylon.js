  ...
  export class BoneIKController {
    ...
    constructor(
      ...
      if (this._bone1.length) {
        ...
        this._bone1Length =
          this._bone1.length * boneScale1.y * this.mesh.scaling.y;
        this._bone2Length =
          this._bone2.length * boneScale2.y * this.mesh.scaling.y;
    ...
    public update(): void {
      ...
      if (this.poleTargetBone) {
        this.poleTargetBone.getAbsolutePositionFromLocalToRef(
          this.poleTargetLocalOffset,
          this.mesh,
          poleTarget
        );
      ...
      if (this._bone1) {
        if (this.slerpAmount < 1) {
          ...
          angC =
            this._bone2Ang * (1.0 - this.slerpAmount) + angC * this.slerpAmount;
