      ...
      switch (buttonIdx) {
        ...
        case 1: // index trigger
          if (this._defaultModel) {
            (<AbstractMesh>this._defaultModel.getChildren()[3]).rotation.x =
              -notifyObject.value * 0.2;
            (<AbstractMesh>this._defaultModel.getChildren()[3]).position.y =
              -notifyObject.value * 0.005;
            (<AbstractMesh>this._defaultModel.getChildren()[3]).position.z =
              -notifyObject.value * 0.005;
          }
        ...
        case 2: // secondary trigger
          if (this._defaultModel) {
            (<AbstractMesh>this._defaultModel.getChildren()[4]).position.x =
              triggerDirection * notifyObject.value * 0.0035;
          }
          this.onSecondaryTriggerStateChangedObservable.notifyObservers(
            notifyObject
          );
          return;
        case 3:
