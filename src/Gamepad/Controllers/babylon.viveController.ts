  ...
  export class ViveController extends WebVRController {
    ...
    public initControllerMesh(
      ...
      SceneLoader.ImportMesh(
        "",
        ViveController.MODEL_BASE_URL,
        ViveController.MODEL_FILENAME,
        scene,
        newMeshes => {
          /*
      ...
      switch (buttonIdx) {
        ...
        case 1: // index trigger
          if (this._defaultModel) {
            (<AbstractMesh>this._defaultModel.getChildren()[6]).rotation.x =
              -notifyObject.value * 0.15;
          }
        ...
        case 3:
          ...
          this.onSecondaryButtonStateChangedObservable.notifyObservers(
            notifyObject
          );
          return;
      }
