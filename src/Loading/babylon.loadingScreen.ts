namespace BABYLON {
  ...
  export class DefaultLoadingScreen implements ILoadingScreen {
    ...
    private _resizeLoadingUI = () => {
      ...
      var canvasPositioning = window.getComputedStyle(this._renderingCanvas)
        .position;
