namespace BABYLON {
  ...
  export abstract class ShadowLight extends Light implements IShadowLight {
    ...
    public customProjectionMatrixBuilder: (
      viewMatrix: Matrix,
      renderList: Array<AbstractMesh>,
      result: Matrix
    ) => void;
    ...
    public getDepthMinZ(activeCamera: Camera): number {
      return this.shadowMinZ !== undefined
        ? this.shadowMinZ
        : activeCamera.minZ;
    }
    ...
    public getDepthMaxZ(activeCamera: Camera): number {
      return this.shadowMaxZ !== undefined
        ? this.shadowMaxZ
        : activeCamera.maxZ;
    }
     ...
     * Returns the light.
     */
    public setShadowProjectionMatrix(
      matrix: Matrix,
      viewMatrix: Matrix,
      renderList: Array<AbstractMesh>
    ): IShadowLight {
