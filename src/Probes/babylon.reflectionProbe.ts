namespace BABYLON {
  export class ReflectionProbe {
    ...
    constructor(
      ...
      this._renderTargetTexture = new RenderTargetTexture(
        name,
        size,
        scene,
        generateMipMaps,
      ...
      this._renderTargetTexture.onBeforeRenderObservable.add(
        (faceIndex: number) => {
          switch (faceIndex) {
            case 0:
    ...
    public setRenderingAutoClearDepthStencil(
      ...
      this._renderTargetTexture.setRenderingAutoClearDepthStencil(
        renderingGroupId,
