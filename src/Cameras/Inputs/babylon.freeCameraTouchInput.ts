namespace BABYLON {
  export class FreeCameraTouchInput implements ICameraInput<FreeCamera> {
    ...
    @serialize() public touchAngularSensibility: number = 200000.0;

    @serialize() public touchMoveSensibility: number = 250.0;
      ...
      if (this._offsetX && this._offsetY) {
        ...
        if (this._pointerPressed.length > 1) {
          ...
          var direction = new Vector3(
            0,
            0,
            speed * this._offsetY / this.touchMoveSensibility
          );
