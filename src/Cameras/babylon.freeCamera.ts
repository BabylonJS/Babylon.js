namespace BABYLON {
  export class FreeCamera extends TargetCamera {
    @serializeAsVector3() public ellipsoid = new Vector3(0.5, 1, 0.5);

    @serializeAsVector3() public ellipsoidOffset = new Vector3(0, 0, 0);

    @serialize() public checkCollisions = false;

    @serialize() public applyGravity = false;
    ...
    public get keysUp(): number[] {
      var keyboard = <FreeCameraKeyboardMoveInput>this.inputs.attached[
        "keyboard"
      ];
    ...
    public _collideWithWorld(displacement: Vector3): void {
      ...
      if (this.parent) {
        globalPosition = Vector3.TransformCoordinates(
          this.position,
      ...
      globalPosition.subtractFromFloatsToRef(
        0,
        this.ellipsoid.y,
        0,
        this._oldPosition
