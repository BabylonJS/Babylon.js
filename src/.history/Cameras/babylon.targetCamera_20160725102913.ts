module BABYLON {
    export class TargetCamera extends Camera {
        ...
        public set rotationQuaternion(newQuaternion: Quaternion) {
            this._rotationQuaternion = newQuaternion;
        }
        ...
        public _isSynchronizedViewMatrix(): boolean {
            ...
            return (this._cache.lockedTarget ? this._cache.lockedTarget.equals(lockedTargetPosition) : !lockedTargetPosition)
                && (this._rotationQuaternion ? this._rotationQuaternion.equals(this._cache.rotationQuaternion) : this._cache.rotation.equals(this.rotation));
        }
        ...
        public setTarget(target: Vector3): void {
            ...
            if (this._rotationQuaternion) {
                Quaternion.RotationYawPitchRollToRef(this.rotation.y, this.rotation.x, this.rotation.z, this._rotationQuaternion);
            }
        }
        ...
        public createRigCamera(name: string, cameraIndex: number): Camera {
            if (this.cameraRigMode !== Camera.RIG_MODE_NONE) {
                ...
                if (this.cameraRigMode === Camera.RIG_MODE_VR) {
                    ...
                    rigCamera._rotationQuaternion = new Quaternion();
                }
                return rigCamera;
            }
            return null;
