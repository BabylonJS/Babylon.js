namespace BABYLON {
  ...
  export class Node {
    ...
    @serialize() public uniqueId: number;

    @serialize() public state = "";

    @serialize() public metadata: any = null;
    ...
    public set parent(parent: Nullable<Node>) {
      ...
      if (
        this._parentNode &&
        this._parentNode._children !== undefined &&
        this._parentNode._children !== null
      ) {
     ...
     */
    public _getDescendants(
      results: Node[],
      directDescendantsOnly: boolean = false,
    ...
    public createAnimationRange(name: string, from: number, to: number): void {
      ...
      if (!this._ranges[name]) {
        ...
        for (
          var i = 0, nAnimations = this.animations.length;
          i < nAnimations;
          i++
        ) {
    ...
    public static ParseAnimationRanges(
      node: Node,
      parsedNode: any,
      scene: Scene
    ): void {
