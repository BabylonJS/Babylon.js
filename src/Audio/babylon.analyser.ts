  ...
  export class Analyser {
    ...
    constructor(scene: Scene) {
      ...
      if (this._audioEngine.canUseWebAudio && this._audioEngine.audioContext) {
        ...
        this._byteFreqs = new Uint8Array(
          this._webAudioAnalyser.frequencyBinCount
        );
        this._byteTime = new Uint8Array(
          this._webAudioAnalyser.frequencyBinCount
        );
        this._floatFreqs = new Float32Array(
          this._webAudioAnalyser.frequencyBinCount
        );
      }
    }
    ...
    public drawDebugCanvas() {
      if (this._audioEngine.canUseWebAudio) {
        ...
        if (this._registerFunc && this._debugCanvasContext) {
          ...
          this._debugCanvasContext.fillRect(
            0,
            0,
          ...
          for (var i = 0; i < this.getFrequencyBinCount(); i++) {
            ...
            var barWidth =
              this.DEBUGCANVASSIZE.width / this.getFrequencyBinCount();
