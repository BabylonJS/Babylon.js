namespace BABYLON {
  ...
  export class HardwareScalingOptimization extends SceneOptimization {
    ...
    public apply(scene: Scene): boolean {
      ...
      return this._directionOffset === 1
  ...
  export class SceneOptimizerOptions {
     ...
     */
    public static LowDegradationAllowed(
     ...
     * @returns a SceneOptimizerOptions object
     */
    public static ModerateDegradationAllowed(
      targetFrameRate?: number
    ): SceneOptimizerOptions {
      var result = new SceneOptimizerOptions(targetFrameRate);
     ...
     * @returns a SceneOptimizerOptions object
     */
    public static HighDegradationAllowed(
      targetFrameRate?: number
    ): SceneOptimizerOptions {
      var result = new SceneOptimizerOptions(targetFrameRate);
  ...
  export class SceneOptimizer implements IDisposable {
     ...
     */
    public static OptimizeAsync(
      scene: Scene,
      options?: SceneOptimizerOptions,
      onSuccess?: () => void,
      onFailure?: () => void
    ): SceneOptimizer {
      let optimizer = new SceneOptimizer(
        scene,
