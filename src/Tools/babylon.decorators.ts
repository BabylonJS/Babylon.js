namespace BABYLON {
      ...
      if (sourceProperty !== undefined && sourceProperty !== null) {
        switch (propertyType) {
          ...
          case 6: // Mesh reference
            ...
            break;
          case 1: // Texture
            (<any>destination)[property] =
              instanciate || sourceProperty.isRenderTarget
                ? sourceProperty
                : sourceProperty.clone();
            break;
          case 2: // Color3
          ...
          case 7: // Color Curves
          case 10: // Quaternion
            (<any>destination)[property] = instanciate
              ? sourceProperty
              : sourceProperty.clone();
            break;
        }
  ...
  function generateExpandMember(
    setCallback: string,
    targetKey: Nullable<string> = null
  ) {
  ...
  export function expandToProperty(
    callback: string,
    targetKey: Nullable<string> = null
  ) {
        ...
        if (sourceProperty !== undefined && sourceProperty !== null) {
          switch (propertyType) {
            ...
            case 1: // Texture
              serializationObject[
                targetPropertyName
              ] = sourceProperty.serialize();
              break;
            case 2: // Color3
              serializationObject[
                targetPropertyName
              ] = sourceProperty.asArray();
              break;
            case 3: // FresnelParameters
              serializationObject[
                targetPropertyName
            ...
            case 8: // Color 4
              serializationObject[
                targetPropertyName
              ] = (<Color4>sourceProperty).asArray();
              break;
            case 9: // Image Processing
              serializationObject[
                targetPropertyName
              ] = (<ImageProcessingConfiguration>sourceProperty).serialize();
              break;
          }
        }
      }
        ...
        if (sourceProperty !== undefined && sourceProperty !== null) {
          ...
          switch (propertyType) {
            ...
            case 8: // Color 4
              ...
              break;
            case 9: // Image Processing
              dest[property] = ImageProcessingConfiguration.Parse(
                sourceProperty
              );
              break;
          }
