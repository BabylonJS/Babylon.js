namespace BABYLON {
  ...
  export class HDRCubeTextureAssetTask extends AbstractAssetTask
    ...
    public run(
      ...
      this.texture = new HDRCubeTexture(
        ...
        this.useInGammaSpace,
        this.usePMREMGenerator,
        onload,
        onerror
      );
    }
  ...
  export class AssetsManager {
    ...
    public addCubeTextureTask(
      ...
      var task = new CubeTextureAssetTask(
        taskName,
        url,
        extensions,
        noMipmap,
    ...
    public addHDRCubeTextureTask(
      ...
      var task = new HDRCubeTextureAssetTask(
        taskName,
        url,
        size,
        noMipmap,
