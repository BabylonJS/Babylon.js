namespace BABYLON {
  export class FilesInput {
    ...
    constructor(
      ...
      progressCallback: (progress: SceneLoaderProgressEvent) => void,
    ...
    private _traverseFolder(
      ...
      var relativePath = folder.fullPath
        .replace(/^\//, "")
        .replace(/(.+?)\/?$/, "$1/");
      ...
      for (var i = 0; i < files.length; i++) {
        ...
        if (
          (extension === "babylon" ||
            ...
            extension === "gltf" ||
            extension === "glb") &&
          name.indexOf(".binary.babylon") === -1 &&
          name.indexOf(".incremental.babylon") === -1
        ) {
