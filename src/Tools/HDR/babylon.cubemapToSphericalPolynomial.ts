namespace BABYLON {
  class FileFaceOrientation {
    ...
    public constructor(
      name: string,
      worldAxisForNormal: Vector3,
      worldAxisForFileX: Vector3,
      worldAxisForFileY: Vector3
    ) {
      this.name = name;
  ...
  export class CubeMapToSphericalPolynomialTools {
     ...
     */
    public static ConvertCubeMapTextureToSphericalPolynomial(
      texture: BaseTexture
    ) {
      if (!texture.isCube) {
     ...
     * @return The Spherical Polynomial data.
     */
    public static ConvertCubeMapToSphericalPolynomial(
      ...
      for (var faceIndex = 0; faceIndex < 6; faceIndex++) {
        ...
        for (var y = 0; y < cubeInfo.size; y++) {
          ...
          for (var x = 0; x < cubeInfo.size; x++) {
            ...
            var worldDirection = fileFace.worldAxisForFileX
              .scale(u)
