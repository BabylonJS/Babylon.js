namespace BABYLON {
  ...
  export class PanoramaToCubeMapTools {
    ...
    public static ConvertPanoramaToCubemap(
      ...
      var textureFront = this.CreateCubemapTexture(
        size,
        this.FACE_FRONT,
        float32Array,
        inputWidth,
      ...
      var textureBack = this.CreateCubemapTexture(
        size,
        this.FACE_BACK,
        float32Array,
        inputWidth,
      ...
      var textureLeft = this.CreateCubemapTexture(
        size,
        this.FACE_LEFT,
        float32Array,
        inputWidth,
      ...
      var textureRight = this.CreateCubemapTexture(
        size,
        this.FACE_RIGHT,
        float32Array,
        inputWidth,
      ...
      var textureUp = this.CreateCubemapTexture(
        size,
        this.FACE_UP,
        float32Array,
        inputWidth,
      ...
      var textureDown = this.CreateCubemapTexture(
        size,
        this.FACE_DOWN,
        float32Array,
        inputWidth,
    ...
    private static CreateCubemapTexture(
      ...
      for (var y = 0; y < texSize; y++) {
        ...
        for (var x = 0; x < texSize; x++) {
          ...
          var color = this.CalcProjectionSpherical(
            v,
            float32Array,
            inputWidth,
            inputHeight
