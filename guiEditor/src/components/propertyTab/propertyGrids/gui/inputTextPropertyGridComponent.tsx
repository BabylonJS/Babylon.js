    ...
    render() {
        ...
        return (
            <div className="pane">
                ...
                <TextInputLineComponent iconLabel={"Highlight color"} icon={fillColorIcon} lockObject={this.props.lockObject} label="" target={inputText} propertyName="textHighlightColor" onPropertyChangedObservable={this.props.onPropertyChangedObservable} />
                ...
                <TextInputLineComponent iconLabel={"Placeholder color"} icon={fillColorIcon} lockObject={this.props.lockObject} label="" target={inputText} propertyName="placeholderColor" onPropertyChangedObservable={this.props.onPropertyChangedObservable} />
            </div>
        );
    }
}