...
describe('Example', function () {
     ...
     */
    describe('#ExponentOfTwo', function () {
        it('should be expoent of two', function () {
            var result = BABYLON.Tools.IsExponentOfTwo(2);
        ...
        it('should not be exponent of two', function () {
            var result = BABYLON.Tools.IsExponentOfTwo(3);
