...
describe('Babylon.Promise', function () {
    ...
    describe('#Composition', function () {
        it('should chain promises correctly #1', function (done) {
            var tempString = "";
        ...
        it('should chain promises correctly #2', function (done) {
            var tempString = "";
            var p1 = new Promise(function (resolve) {
                tempString = "Initial";
                resolve();
        ...
        it('should chain promises correctly #3', function (done) {
            var tempString = "";
        ...
        it('should chain promises correctly #4', function (done) {
        ...
        it('should chain promises correctly #5', function (done) {
            var tempString = "";
        ...
        it('should chain promises correctly #6', function (done) {
            var tempString = "";
            var promise = new Promise(function (resolve) {
                setTimeout(function () {
                    resolve(44);
    ...
    describe('#Promise.all', function () {
        it('should agregate promises correctly', function (done) {
    ...
    describe('#Returning value', function () {
        it('should correctly handle returned values', function (done) {
            Promise.resolve(1)
                .then(function (number) { return number + 1; })
                .then(function (number) { return number + 1; })
        ...
        it('should correctly handle then multiple times', function (done) {
            var promise = Promise.resolve().then(function () {
    ...
    describe('#Multiple children', function () {
        it('should correctly handle multiple independent "then"', function (done) {
            var successValue = 'Success!';
            var promise1 = BABYLON.Tools.DelayAsync(500).then(function () { return successValue; });
            var sum = 0;
            var checkDone = function (value) {
                sum++;
                if (sum === 2) {
                    try {
    ...
    describe('#All and then', function () {
        it('should correctly handle chaining a returning then after a all', function (done) {
    ...
    describe('#Move children', function () {
        it('should correctly handle moving children', function (done) {
    ...
    describe('#Error handling', function () {
        it('should correctly handle exceptions', function (done) {
        ...
        it('should correctly handle exceptions in a reject handler', function (done) {
            var errorValue = 'Failed!';
            var promise = new Promise(function (resolve, reject) {
                throw new Error(errorValue);
            }).catch(function (error) {
