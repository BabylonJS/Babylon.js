...
#include<logDepthVertex>\n\
    ...
    var CustomMaterial2 = (function (_super) {
        ...
        function CustomMaterial2(name, scene) {
        ...
        CustomMaterial2.prototype.ReviewUniform = function (name, arr) {
            if (name == "uniform") {
        ...
        CustomMaterial2.prototype.SelectVersion = function (ver) {
            switch (ver) {
                case "3.0.0":
        ...
        CustomMaterial2.prototype.AddUniform = function (name, kind, param) {
