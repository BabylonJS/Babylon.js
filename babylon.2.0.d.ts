...
declare module BABYLON {
    ...
    class Scene {
        ...
        getMeshesByTags(tagsQuery: string): Mesh[];
        getCamerasByTags(tagsQuery: string): Camera[];
        getLightsByTags(tagsQuery: string): Light[];
        getMaterialByTags(tagsQuery: string): Material[];
    }
}
declare module BABYLON {
    class Action {
...
declare module BABYLON {
    class Sound {
        ...
        */
        constructor(name: string, urlOrArrayBuffer: any, scene: BABYLON.Scene, readyToPlayCallback?: () => void, options?: any);
        ...
        */
        ...
        getVolume(): number;
        attachToMesh(meshToConnectTo: BABYLON.AbstractMesh): void;
...
declare module BABYLON {
    ...
    class Mesh extends AbstractMesh implements IGetSetVerticesData {
        ...
        dispose(doNotRecurse?: boolean): void;
        applyDisplacementMap(url: string, minHeight: number, maxHeight: number): void;
