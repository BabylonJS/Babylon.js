...
float computeShadow(vec4 vPositionFromLight, sampler2D shadowSampler, float grayLevel)
{
...
#else
	shadow = computeShadow(vPositionFromLight0, shadowSampler0, grayLevel0);
#endif
#else
	shadow = 1.;
#endif
...
#else
	shadow = computeShadow(vPositionFromLight1, shadowSampler1, grayLevel1);
#endif
#else
	shadow = 1.;
#endif
...
#else
	shadow = computeShadow(vPositionFromLight2, shadowSampler2, grayLevel2);
#endif	
#else
	shadow = 1.;
#endif
...
#else
	shadow = computeShadow(vPositionFromLight3, shadowSampler3, grayLevel3);
#endif	
#else
	shadow = 1.;
#endif
