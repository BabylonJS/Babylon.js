module BABYLON {
    ...
    export class VertexData {
        ...
        public static CreateRibbon(pathArray: Vector3[][], closeArray: boolean, closePath: boolean, offset: number, sideOrientation: number = BABYLON.Mesh.DefaultSide): VertexData {
        ...
        public static CreateSphere(segments: number, diameter: number, sideOrientation: number = BABYLON.Mesh.DefaultSide): VertexData {
        ...
        public static CreateCylinder(height: number, diameterTop: number, diameterBottom: number, tessellation: number, sideOrientation: number, subdivisions: number = 1): VertexData {
        ...
        public static CreateTorus(diameter, thickness, tessellation, sideOrientation: number) {
            var indices = [];
            var positions = [];
            var normals = [];
            var uvs = [];
        ...
        public static CreateTorusKnot(radius: number, tube: number, radialSegments: number, tubularSegments: number, p: number, q: number, sideOrientation: number): VertexData {
            var indices = [];
            var positions = [];
            var normals = [];
            var uvs = [];
