module BABYLON {
    ...
    export module Geometry.Primitives {
        ...
        export class Box extends _Primitive {
            ...
            constructor(id: string, scene: Scene, size: number, side:number, canBeRegenerated?: boolean, mesh?: Mesh) {
                this.size = size;
                this.side = side;
        ...
        export class Sphere extends _Primitive {
            ...
            constructor(id: string, scene: Scene, segments: number, diameter: number, side: number, canBeRegenerated?: boolean, mesh?: Mesh) {
        ...
        export class Torus extends _Primitive {
            ...
            constructor(id: string, scene: Scene, diameter: number, thickness: number, tessellation: number, side: number, canBeRegenerated?: boolean, mesh?: Mesh) {
                this.diameter = diameter;
        ...
        export class TorusKnot extends _Primitive {
            ...
            constructor(id: string, scene: Scene, radius: number, tube: number, radialSegments: number, tubularSegments: number, p: number, q: number, side: number, canBeRegenerated?: boolean, mesh?: Mesh) {
                this.radius = radius;
                this.tube = tube;
