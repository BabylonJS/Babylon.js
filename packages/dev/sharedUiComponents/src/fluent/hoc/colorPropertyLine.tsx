...
const ColorPropertyLine = forwardRef<HTMLDivElement, ColorPropertyLineProps>((props, ref) => {
    ...
    return (
        <PropertyLine
            ...
            expandedContent={
                <>
                    <SyncedSliderLine label="R" value={color.r * 255.0} min={0} max={255} onChange={(value) => onSliderChange(value, "r")} />
                    <SyncedSliderLine label="G" value={color.g * 255.0} min={0} max={255} onChange={(value) => onSliderChange(value, "g")} />
                    <SyncedSliderLine label="B" value={color.b * 255.0} min={0} max={255} onChange={(value) => onSliderChange(value, "b")} />
