 ...
 * @experimental
 */
export interface IFlowGraphGetPropertyGLTFBlockConfiguration extends IFlowGraphBlockConfiguration {
    /**
...
export class FlowGraphGetPropertyBlockGLTF<T = any> extends FlowGraphBlock {
    ...
    public constructor(
         ...
         */
        public override config: IFlowGraphGetPropertyGLTFBlockConfiguration
    ) {
        super(config);
