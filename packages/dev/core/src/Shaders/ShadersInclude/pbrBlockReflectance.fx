    ...
    vec3 baseSpecularEnvironmentReflectance = getReflectanceFromBRDFLookup(vec3(reflectanceF0), specularEnvironmentR90, ior, environmentBrdf);
    ...
    vec3 baseSpecularEnvironmentReflectance = vec3(reflectanceF0);
#endif
