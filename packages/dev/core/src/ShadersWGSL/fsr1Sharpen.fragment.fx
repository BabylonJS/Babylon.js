...
fn FsrRcasF(
    ...
    con: vec4f // Constant generated by RcasSetup().
) {
    ...
    var lobe=max(f32(-FSR_RCAS_LIMIT),min(AMax3F1(lobeR,lobeG,lobeB),f32(0.0)))*con.x;
    // Apply noise removal.
...
fn main(input: FragmentInputs) -> FragmentOutputs {
    ...
    FsrRcasF(&pixR, &pixG, &pixB, ip, uniforms.con);
