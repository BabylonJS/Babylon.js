uniform grlColors: texture_2d<f32>;
...
fn main(input: FragmentInputs) -> FragmentOutputs {
    ...
    let grlColorMode: f32 = grl_colorModeAndColorDistributionType.x;
    let grlColorDistributionType: f32 = grl_colorModeAndColorDistributionType.y;
