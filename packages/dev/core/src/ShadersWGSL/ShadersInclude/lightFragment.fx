        ...
        #define CUSTOM_LIGHT{X}_COLOR // Use to modify light color. Currently only supports diffuse.
            ...
            // Clear Coat contribution
                ...
                info = computeAreaLighting(areaLightsLTC1Sampler, areaLightsLTC2Sampler, viewDirectionW, normalW, fragmentInputs.vPositionW, light{X}.vLightData, light{X}.vLightWidth.xyz, light{X}.vLightHeight.xyz, diffuse{X}.rgb, light{X}.vLightSpecular.rgb, uniforms.vReflectionInfos.y);
            #endif
        #endif
