...
// _____________________________ Irradiance ______________________________________
    ...
    #if defined(SS_REFRACTION) && !defined(LEGACY_SPECULAR_ENERGY_CONSERVATION) // if LEGACY_SPECULAR_ENERGY_CONSERVATION is defined, sufaceAlbedo has already been multiplied by refractionOpacity (and finalIrradiance is already or will be multiplied by surfaceAlbedo)
