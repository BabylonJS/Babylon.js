...
uniform vSubsurfaceColor: vec3f;
uniform vSubsurfaceRadius: f32;
uniform vSubsurfaceRadiusScale: vec3f;
...
uniform vGeometryThinWalled: f32;
...
uniform vSubsurfaceWeightInfos: vec2f;
uniform subsurfaceWeightMatrix: mat4x4f;
uniform vSubsurfaceColorInfos: vec2f;
uniform subsurfaceColorMatrix: mat4x4f;
uniform vSubsurfaceRadiusScaleInfos: vec2f;
uniform subsurfaceRadiusScaleMatrix: mat4x4f;
