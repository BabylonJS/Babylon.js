    ...
    // Specular Lobe
    ...
    #else
        {
            ...
            specularColoredFresnel = specularFresnel * specular_color;
                ...
                specularColoredFresnel = mix(specularColoredFresnel, thinFilmDielectricFresnel * specular_color, thin_film_weight);
            #endif
        }
    #endif
    ...
    // Metal Lobe
    ...
    #else
        {
            ...
            // usual Schlick lobe.
                ...
                var coloredFresnel: vec3f = specular_weight * getF82Specular(preInfo{X}.VdotH, baseConductorReflectance.coloredF0, baseConductorReflectance.coloredF90, specular_roughness);
            #else
