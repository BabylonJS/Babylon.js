...
#include<samplerFragmentDeclaration>(_DEFINENAME_,SPECULAR_RETROREFLECTIVITY,_VARYINGNAME_,SpecularRetroreflectivity,_SAMPLERNAME_,specularRetroreflectivity)
