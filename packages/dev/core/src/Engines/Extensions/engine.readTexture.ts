import { _readTexturePixelsSync } from "core/esm/Engines/WebGL/Extensions/readTexture/readTexture.webgl";
...
ThinEngine.prototype._readTexturePixelsSync = function (
    ...
    return _readTexturePixelsSync(this._engineState, texture, width, height, faceIndex, level, buffer, flushRenderer, noDataConversion, x, y);
};
