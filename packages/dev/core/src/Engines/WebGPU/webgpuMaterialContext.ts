...
import { TEXTURETYPE_FLOAT, TEXTUREFORMAT_DEPTH24_STENCIL8, TEXTUREFORMAT_DEPTH32FLOAT_STENCIL8 } from "../constants";
    ...
    public setTexture(name: string, texture: Nullable<InternalTexture | ExternalTexture>): void {
        ...
        if (texture) {
            textureCache.isFloatOrDepthTexture =
                texture.type === TEXTURETYPE_FLOAT || (texture.format >= TEXTUREFORMAT_DEPTH24_STENCIL8 && texture.format <= TEXTUREFORMAT_DEPTH32FLOAT_STENCIL8);
