...
export const enum TextureFilteringQuality {
...
export const Constants = {
    ...
    TEXTURE_FILTERING_QUALITY_OFFLINE: TextureFilteringQuality.OFFLINE,
    TEXTURE_FILTERING_QUALITY_HIGH: TextureFilteringQuality.HIGH,
    TEXTURE_FILTERING_QUALITY_MEDIUM: TextureFilteringQuality.MEDIUM,
    TEXTURE_FILTERING_QUALITY_LOW: TextureFilteringQuality.LOW,
