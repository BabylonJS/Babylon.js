...
export interface EngineFeatures {
    ...
    /** Indicates that even if we don't have to update the properties of a uniform buffer (because of some optimizations in the material) we still need to bind the uniform buffer themselves */
