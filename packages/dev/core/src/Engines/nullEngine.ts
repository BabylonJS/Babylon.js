...
export class NullEngine extends Engine {
     ...
     * @internal
     */
    public _createHardwareRenderTargetWrapper(isMulti: boolean, isCube: boolean, size: number | { width: number; height: number; depth?: number; layers?: number }): RenderTargetWrapper {
