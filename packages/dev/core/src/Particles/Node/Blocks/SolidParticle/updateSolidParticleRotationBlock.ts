...
/**
 * Block used to update the rotation of a solid particle
 */
export class UpdateSolidParticleRotationBlock extends NodeParticleBlock {
    ...
    public override getClassName() {
        return "UpdateSolidParticleRotationBlock";
    }
...
RegisterClass("BABYLON.UpdateSolidParticleRotationBlock", UpdateSolidParticleRotationBlock);
