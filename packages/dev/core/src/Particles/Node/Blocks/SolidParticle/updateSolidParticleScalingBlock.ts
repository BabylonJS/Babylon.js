...
/**
 * Block used to update the scaling of a solid particle
 */
export class UpdateSolidParticleScalingBlock extends NodeParticleBlock {
    ...
    public override getClassName() {
        return "UpdateSolidParticleScalingBlock";
    }
...
RegisterClass("BABYLON.UpdateSolidParticleScalingBlock", UpdateSolidParticleScalingBlock);
