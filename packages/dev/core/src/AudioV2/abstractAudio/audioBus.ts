...
import type { ICommonBusOptions } from "./abstractAudioBus";
 ...
 */
export interface IAudioBusOptions extends ICommonBusOptions, ISpatialAudioOptions, IStereoAudioOptions {
    /**
