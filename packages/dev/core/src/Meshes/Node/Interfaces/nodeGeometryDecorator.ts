...
export interface IEditablePropertyOption {
    ...
    notifiers?: {
        /** the geometry should be rebuilt */
        rebuild?: boolean;
        ...
        onValidation?: (block: NodeGeometryBlock, propertyName: string) => boolean;
    };
...
/**
 * Decorator that flags a property in a node geometry block as being editable
 * @param displayName
 * @param propertyType
 * @param groupName
 * @param options
