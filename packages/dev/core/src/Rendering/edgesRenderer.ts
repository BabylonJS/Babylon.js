...
declare module "../Meshes/abstractMesh" {
    export interface AbstractMesh {
        /**
         * @returns the edgesRenderer associated with the mesh
         */
...
export interface IEdgesRendererOptions {
    /**
     * @returns a boolean indicating that the alternate edge finder algorithm must be used
     * If not defined, the default value is true
     */
    useAlternateEdgeFinder?: boolean;

    /**
     * @returns a boolean indicating that the vertex merger fast processing must be used.
     * If not defined, the default value is true.
    ...
    /**
     * @returns a boolean indicating that tessellation should be applied before finding the edges. You may need to activate this option if your geometry is a bit
    ...
    /**
     * @returns a boolean indicating that degenerated triangles should not be processed.
