...
export class Octree<T> {
     ...
     * @param worldMin worldMin for the octree blocks var blockSize = new Vector3((worldMax.x - worldMin.x) * 0.5, (worldMax.y - worldMin.y) * 0.5, (worldMax.z - worldMin.z) * 0.5);
     * @param worldMax worldMax for the octree blocks var blockSize = new Vector3((worldMax.x - worldMin.x) * 0.5, (worldMax.y - worldMin.y) * 0.5, (worldMax.z - worldMin.z) * 0.5);
