    ...
    public toString(fullDetails?: boolean): string {
        ...
        if (fullDetails) {
            ...
            /*
            	...
            	The original code concatenated the array object itself (producing "[object Object],...")
            	instead of its .length property, which is what the label "animatables length:" implies.
            */
