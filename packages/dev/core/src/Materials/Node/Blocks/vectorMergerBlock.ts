...
export class VectorMergerBlock extends NodeMaterialBlock {
    /**
     * @returns the swizzle for x (meaning which compoent to affect to the output.x)
     */
    public xSwizzle: "x" | "y" | "z" | "w" = "x";
    /**
     * @returns the swizzle for y (meaning which compoent to affect to the output.y)
     */
    public ySwizzle: "x" | "y" | "z" | "w" = "y";
    /**
     * @returns the swizzle for z (meaning which compoent to affect to the output.z)
     */
    public zSwizzle: "x" | "y" | "z" | "w" = "z";
    /**
     * @returns the swizzle for w (meaning which compoent to affect to the output.w)
     */
