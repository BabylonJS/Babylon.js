...
import { MATERIAL_TextureDirtyFlag, MATERIAL_FresnelDirtyFlag } from "../Engines/constants";
...
export class MaterialFlags {
    ...
    public static set DiffuseTextureEnabled(value: boolean) {
        ...
        Engine.MarkAllMaterialsAsDirty(MATERIAL_TextureDirtyFlag);
    }
    ...
    public static set FresnelEnabled(value: boolean) {
        ...
        Engine.MarkAllMaterialsAsDirty(MATERIAL_FresnelDirtyFlag);
    }
