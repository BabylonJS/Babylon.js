...
function mapSRGBToLinear(format: number): Nullable<number> {
    switch (format) {
        case TextureFormat.COMPRESSED_SRGB_S3TC_DXT1_EXT:
            return TextureFormat.COMPRESSED_RGB_S3TC_DXT1;
        case TextureFormat.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT:
            return TextureFormat.COMPRESSED_RGBA_S3TC_DXT3;
        case TextureFormat.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT:
            return TextureFormat.COMPRESSED_RGBA_S3TC_DXT5;
        ...
        case TextureFormat.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:
            return TextureFormat.COMPRESSED_RGBA_ASTC_4x4;
        case TextureFormat.COMPRESSED_SRGB_ALPHA_BPTC_UNORM:
            return TextureFormat.COMPRESSED_RGBA_BPTC_UNORM;
    }
