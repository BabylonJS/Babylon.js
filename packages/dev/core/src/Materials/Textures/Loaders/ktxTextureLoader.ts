        ...
        if (KhronosTextureContainer.IsValid(data)) {
            ...
            switch (ktx.glInternalFormat) {
                ...
                case Constants.TEXTUREFORMAT_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2:
                    ...
                    // Leave texture._useSRGBBuffer alone.
                    break;
                case Constants.TEXTUREFORMAT_COMPRESSED_SRGB_S3TC_DXT1_EXT:
                    texture.format = Constants.TEXTUREFORMAT_COMPRESSED_RGB_S3TC_DXT1;
                    texture._useSRGBBuffer = true;
                    break;
                case Constants.TEXTUREFORMAT_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT:
                    texture.format = Constants.TEXTUREFORMAT_COMPRESSED_RGBA_S3TC_DXT3;
                    texture._useSRGBBuffer = true;
                    break;
                case Constants.TEXTUREFORMAT_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT:
                    texture.format = Constants.TEXTUREFORMAT_COMPRESSED_RGBA_S3TC_DXT5;
                    texture._useSRGBBuffer = true;
                    break;
                case Constants.TEXTUREFORMAT_COMPRESSED_SRGB8_ETC2:
                    texture.format = Constants.TEXTUREFORMAT_COMPRESSED_RGB8_ETC2;
                    texture._useSRGBBuffer = true;
                    break;
                case Constants.TEXTUREFORMAT_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:
                    texture.format = Constants.TEXTUREFORMAT_COMPRESSED_RGBA8_ETC2_EAC;
                    texture._useSRGBBuffer = true;
                    break;
                case Constants.TEXTUREFORMAT_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2:
                    texture.format = Constants.TEXTUREFORMAT_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2;
                    texture._useSRGBBuffer = true;
                    break;
                case Constants.TEXTUREFORMAT_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:
                    texture.format = Constants.TEXTUREFORMAT_COMPRESSED_RGBA_ASTC_4x4;
                    texture._useSRGBBuffer = true;
                    break;
                case Constants.TEXTUREFORMAT_COMPRESSED_SRGB_ALPHA_BPTC_UNORM:
                    texture.format = Constants.TEXTUREFORMAT_COMPRESSED_RGBA_BPTC_UNORM;
                    texture._useSRGBBuffer = true;
                    break;
            }
