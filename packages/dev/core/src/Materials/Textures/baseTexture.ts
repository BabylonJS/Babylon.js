...
export class BaseTexture extends ThinTexture implements IAnimatable {
     ...
     * Note that you can use @see {@link GetTextureDataAsync} instead, which will also support reading from a compressed texture (by rendering it to an intermediate RGBA texture and retrieving the bytes from it)
