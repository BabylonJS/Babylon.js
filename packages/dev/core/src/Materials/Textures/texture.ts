...
export class Texture extends BaseTexture {
    ...
    constructor(
        ...
        if (typeof noMipmapOrOptions === "object" && noMipmapOrOptions !== null) {
            ...
            invertY = noMipmapOrOptions.invertY ?? !CompatibilityOptions.UseOpenGLOrientationForUV;
        ...
        this._invertY = invertY === undefined ? !CompatibilityOptions.UseOpenGLOrientationForUV : invertY;
