        ...
        <div className={styles.root}>
            ...
            <div className={styles.form}>
                ...
                <div className={styles.row}>
                    <StringDropdown
                        value={mode}
                        onChange={(val) => setMode(val as (typeof MODES)[number])}
                        options={ModeOptions}
                ...
                <div className={styles.row}>
                    ...
                    {isCustomMode ? (
                        <TextInput value={customProperty} onChange={setCustomProperty} />
                    ) : (
                        <StringDropdown value={selectedProperty} onChange={(val) => setSelectedProperty(val)} options={properties.map((p) => ({ label: p, value: p }))} />
                    )}
                </div>
                ...
                <div className={styles.row}>
                    <Label>Type</Label>
                    {isCustomMode ? (
                        <StringDropdown value={animationType} onChange={(val) => setAnimationType(val as (typeof ANIMATION_TYPES)[number])} options={AnimationTypeOptions} />
                    ) : (
                ...
                <div className={styles.row}>
                    <StringDropdown
                        value={loopMode}
                        onChange={(val) => setLoopMode(val as (typeof LOOP_MODES)[number])}
                        options={LoopModeOptions}
                        infoLabel={{ label: "Loop Mode" }}
                    />
                </div>
            </div>
