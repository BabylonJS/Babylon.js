...
export const ParticleSystemExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext, IWatcher]> = {
    ...
    factory: (sceneExplorerService, sceneContext, watcher) => {
        ...
        const sectionRegistration = sceneExplorerService.addSection({
            ...
            getEntityDisplayInfo: (particleSystem) => {
                ...
                const nameHookToken = watcher.watchProperty(particleSystem, "name", () => onChangeObservable.notifyObservers());
