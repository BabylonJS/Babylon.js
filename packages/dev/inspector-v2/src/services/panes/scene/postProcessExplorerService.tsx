...
export const PostProcessExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext, IWatcher]> = {
    ...
    factory: (sceneExplorerService, sceneContext, watcher) => {
        ...
        const sectionRegistration = sceneExplorerService.addSection({
            ...
            getEntityDisplayInfo: (postProcess) => {
                ...
                const nameHookToken = watcher.watchProperty(postProcess, "name", () => onChangeObservable.notifyObservers());
