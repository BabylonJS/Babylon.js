...
export class MRDLSliderBarMaterial extends PushMaterial {
    ...
    /**
     * @returns the corner Radius on the slider bar.
     */
    @serialize()
    public radius = 0.6;

    /**
     * @returns the Bevel Front on the slider bar.
     */
    @serialize()
    public bevelFront = 0.6;

    /**
     * @returns the Bevel Front Stretch on the slider bar.
     */
    @serialize()
    public bevelFrontStretch = 0.077;

    /**
     * @returns the Bevel Back on the slider bar.
     */
    @serialize()
    public bevelBack = 0;

    /**
     * @returns the Bevel Back Stretch on the slider bar.
     */
    @serialize()
