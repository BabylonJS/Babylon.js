...
export class KHR_materials_clearcoat implements IGLTFLoaderExtension {
    ...
    public loadMaterialPropertiesAsync(context: string, material: IMaterial, babylonMaterial: Material): Nullable<Promise<void>> {
        return LoadExtensionAsync<IKHRMaterialsClearcoat>(context, material, this.name, (extensionContext, extension) => {
...
GLTFLoader.RegisterExtension(NAME, (loader) => new KHR_materials_clearcoat(loader as GLTFLoader));
