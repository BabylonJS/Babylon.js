    ...
    public onLoading(): void {
        ...
        if (xmp_gltf && xmp_node) {
            ...
            if (xmp_gltf.packets && packet < xmp_gltf.packets.length) {
                this._loader.rootBabylonMesh._internalMetadata = this._loader.rootBabylonMesh._internalMetadata || {};
                this._loader.rootBabylonMesh._internalMetadata.xmp = xmp_gltf.packets[packet];
            }
        }
    }
}
