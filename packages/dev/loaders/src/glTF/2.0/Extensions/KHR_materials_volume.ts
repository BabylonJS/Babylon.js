...
export class KHR_materials_volume implements IGLTFLoaderExtension {
    ...
    public loadMaterialPropertiesAsync(context: string, material: IMaterial, babylonMaterial: Material): Nullable<Promise<void>> {
        return LoadExtensionAsync<IKHRMaterialsVolume>(context, material, this.name, (extensionContext, extension) => {
...
GLTFLoader.RegisterExtension(NAME, (loader) => new KHR_materials_volume(loader as GLTFLoader));
