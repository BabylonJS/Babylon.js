...
export function registerBuiltInGLTFExtensions() {
    ...
    GLTFLoaderExtensionRegistry.Register("KHR_materials_dispersion", true, async (loader) => {
        const { KHR_materials_dispersion } = await import("./KHR_materials_dispersion");
        return new KHR_materials_dispersion(loader);
    });

    GLTFLoaderExtensionRegistry.Register("KHR_materials_emissive_strength", true, async (loader) => {
    ...
    GLTFLoaderExtensionRegistry.Register("KHR_materials_ior", true, async (loader) => {
        const { KHR_materials_ior } = await import("./KHR_materials_ior");
        return new KHR_materials_ior(loader);
    });

    GLTFLoaderExtensionRegistry.Register("KHR_materials_iridescence", true, async (loader) => {
