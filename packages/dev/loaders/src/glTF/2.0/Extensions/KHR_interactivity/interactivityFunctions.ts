...
// import { gltfTypeToBabylonType, convertGLTFValueToFlowGraph, getMappingForOperation } from "./interactivityUtils";
...
//     const mapping = getMappingForOperation(gltfBlock.type);
//     if (!mapping) {
...
//         }
//         const outputMapper = getMappingForOperation(gltfBlock.type);
...
//                 );
//             }
//             const inputMapper = getMappingForOperation(nodeIn.type);
//             if (!inputMapper) {
...
//                     );
//                 }
//                 const outputMapper = getMappingForOperation(nodeOut.type);
//                 if (!outputMapper) {
