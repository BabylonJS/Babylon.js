        ...
        return (
            <div>
                ...
                {this.state.mode !== Scene.FOGMODE_NONE && (
                    <Color3LineComponent lockObject={this.props.lockObject} label="Fog color" target={scene} propertyName="fogColor" onPropertyChangedObservable={this.props.onPropertyChangedObservable} />
                )}
