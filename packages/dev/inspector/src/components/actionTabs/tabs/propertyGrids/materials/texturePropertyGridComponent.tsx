...
const textureFormat = [
    { label: "Alpha", normalizable: 0, value: TextureFormat.ALPHA },
    { label: "Luminance", normalizable: 0, value: TextureFormat.LUMINANCE },
    { label: "Luminance/Alpha", normalizable: 0, value: TextureFormat.LUMINANCE_ALPHA },
    { label: "RGB", normalizable: 1, value: TextureFormat.RGB },
    { label: "RGBA", normalizable: 1, value: TextureFormat.RGBA },
    { label: "R (red)", normalizable: 1, value: TextureFormat.RED },
    { label: "RG (red/green)", normalizable: 1, value: TextureFormat.RG },
    { label: "R (red) integer", normalizable: 0, value: TextureFormat.RED_INTEGER },
    { label: "RG (red/green) integer", normalizable: 0, value: TextureFormat.RG_INTEGER },
    { label: "RGB integer", normalizable: 0, value: TextureFormat.RGB_INTEGER },
    { label: "RGBA integer", normalizable: 0, value: TextureFormat.RGBA_INTEGER },
    { label: "BGRA", normalizable: 1, value: TextureFormat.BGRA },
    { label: "Depth24/Stencil8", normalizable: 0, hideType: true, value: TextureFormat.DEPTH24_STENCIL8 },
    { label: "Depth32 float", normalizable: 0, hideType: true, value: TextureFormat.DEPTH32_FLOAT },
    { label: "Depth16", normalizable: 0, value: TextureFormat.DEPTH16 },
    { label: "Depth24", normalizable: 0, value: TextureFormat.DEPTH24 },
    { label: "Depth24Unorm/Stencil8", normalizable: 0, hideType: true, value: TextureFormat.DEPTH24UNORM_STENCIL8 },
    { label: "Depth32Float/Stencil8", normalizable: 0, hideType: true, value: TextureFormat.DEPTH32FLOAT_STENCIL8 },
    { label: "RGBA BPTC UNorm", normalizable: 0, compressed: true, value: TextureFormat.COMPRESSED_RGBA_BPTC_UNORM },
    { label: "RGB BPTC UFloat", normalizable: 0, compressed: true, value: TextureFormat.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT },
    { label: "RGB BPTC SFloat", normalizable: 0, compressed: true, value: TextureFormat.COMPRESSED_RGB_BPTC_SIGNED_FLOAT },
    { label: "RGBA S3TC DXT5", normalizable: 0, compressed: true, value: TextureFormat.COMPRESSED_RGBA_S3TC_DXT5 },
    { label: "RGBA S3TC DXT3", normalizable: 0, compressed: true, value: TextureFormat.COMPRESSED_RGBA_S3TC_DXT3 },
    { label: "RGBA S3TC DXT1", normalizable: 0, compressed: true, value: TextureFormat.COMPRESSED_RGBA_S3TC_DXT1 },
    { label: "RGB S3TC DXT1", normalizable: 0, compressed: true, value: TextureFormat.COMPRESSED_RGB_S3TC_DXT1 },
    { label: "RGBA ASTC 4x4", normalizable: 0, compressed: true, value: TextureFormat.COMPRESSED_RGBA_ASTC_4x4 },
];
