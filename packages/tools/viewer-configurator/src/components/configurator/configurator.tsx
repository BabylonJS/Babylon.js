...
import type { ViewerElement } from "viewer/index";
...
export const Configurator: FunctionComponent<{ viewerElement?: ViewerElement }> = (props) => {
    const viewerElement = props.viewerElement;
