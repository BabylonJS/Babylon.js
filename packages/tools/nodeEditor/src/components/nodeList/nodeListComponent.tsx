...
export class NodeListComponent extends React.Component<INodeListComponentProps, { filter: string }> {
    ...
    private static _Tooltips: { [key: string]: string } = {
        ...
        FragmentOutputBlock: "A mandatory final node for outputting the color of each pixel",
        VertexOutputBlock: "A mandatory final node for outputting the position of each vertex",
