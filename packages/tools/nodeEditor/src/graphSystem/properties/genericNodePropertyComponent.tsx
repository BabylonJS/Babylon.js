        ...
        for (const { propertyName, displayName, type, groupName, options } of propStore) {
            ...
            switch (type) {
                ...
                case PropertyTypeForEdition.Vector2: {
                    components.push(<Vector2LineComponent lockObject={this.props.stateManager.lockObject} label={displayName} propertyName={propertyName} target={block} onChange={() => this.forceRebuild(options.notifiers)} />);
                    break;
                }
