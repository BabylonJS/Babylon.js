    ...
    stateManager.applyNodePortDesign = (portData: IPortData, element: HTMLElement, img: HTMLImageElement, pip: HTMLDivElement) => {
        ...
        switch (type) {
            ...
            case NodeRenderGraphBlockConnectionPointTypes.TextureBackBufferDepthStencilAttachment:
                ...
                break;
            // case NodeRenderGraphBlockConnectionPointTypes.Vector3:
            //     img.src =
            ...
            //     break;
            // case NodeRenderGraphBlockConnectionPointTypes.Vector4:
            //     img.src =
            ...
            //     break;
            // case NodeRenderGraphBlockConnectionPointTypes.Matrix:
            //     img.src =
            ...
            //     break;
            // case NodeRenderGraphBlockConnectionPointTypes.XXXX:
            //     img.src =
        ...
        if (!point.isConnected && point.value !== undefined && point.value !== null) {
            pip.style.display = "";
        } else {
