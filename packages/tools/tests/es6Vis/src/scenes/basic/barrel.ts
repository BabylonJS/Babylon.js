/**
 * Basic scene — barrel import style.
 * Imports everything from the top-level "@babylonjs/core" index.
 */

import { Engine, Scene, FreeCamera, HemisphericLight, MeshBuilder, StandardMaterial, Vector3, Color3 } from "@babylonjs/core";
