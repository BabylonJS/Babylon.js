/**
 * pbr-node-material - barrel import style.
 */
import { Engine, Scene, ArcRotateCamera, HemisphericLight, MeshBuilder, PBRMaterial, CubeTexture, NodeMaterial, Color3, Color4, Vector3 } from "@babylonjs/core";
...
export function run(canvas: HTMLCanvasElement): void {
    ...
    const cyl = MeshBuilder.CreateCylinder("cyl", { diameter: 1, height: 2.5 }, scene);
