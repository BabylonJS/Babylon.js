/**
 * gui-dashboard — barrel import style.
 * 2D GUI with buttons, sliders, text, and interactive controls.
 */
import { Engine, Scene, ArcRotateCamera, HemisphericLight, MeshBuilder, PBRMaterial, Color3, Color4, Vector3 } from "@babylonjs/core";
import { AdvancedDynamicTexture, StackPanel, Button, Slider, TextBlock, Control } from "@babylonjs/gui";
