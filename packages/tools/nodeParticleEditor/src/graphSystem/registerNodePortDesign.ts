    ...
    stateManager.applyNodePortDesign = (portData: IPortData, element: HTMLElement, imgHost: HTMLImageElement, pip: HTMLDivElement) => {
        ...
        switch (type) {
            ...
            case NodeParticleBlockConnectionPointTypes.Mesh:
                svg =
                    "";
                // Replace icon color with connection color
                const connectionColor = BlockTools.GetColorFromConnectionNodeType(type);
                const decoded = atob(svg);
                svg = btoa(decoded.replace(/#84995c/gi, connectionColor));
                break;
