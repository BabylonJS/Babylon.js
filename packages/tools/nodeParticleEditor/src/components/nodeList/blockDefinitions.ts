...
export const BlockDefinitions: IBlockDefinition[] = [
    ...
    { name: "SolidParticleVelocityBlock", category: "Contextual", modes: [NodeParticleModes.SolidParticle], tooltip: "Contextual block to get the velocity of a solid particle" },
    { name: "SolidParticleScalingBlock", category: "Contextual", modes: [NodeParticleModes.SolidParticle], tooltip: "Contextual block to get the scaling of a solid particle" },
    { name: "SolidParticleRotationBlock", category: "Contextual", modes: [NodeParticleModes.SolidParticle], tooltip: "Contextual block to get the rotation of a solid particle" },
