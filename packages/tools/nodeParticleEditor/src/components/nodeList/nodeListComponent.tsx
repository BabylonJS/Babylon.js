...
export class NodeListComponent extends React.Component<INodeListComponentProps, { filter: string }> {
    ...
    private static _Tooltips: { [key: string]: string } = {
        ...
        TextureFetchBlock: "Fetch a color from a texture",
    ...
    override render() {
        ...
        const allBlocks: any = {
            ...
            Misc: ["ConverterBlock", "RandomBlock", "DebugBlock", "ElbowBlock", "TeleportInBlock", "TeleportOutBlock", "LocalVariableBlock", "FresnelBlock", "TextureFetchBlock"],
