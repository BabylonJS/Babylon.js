...
export class NodeListComponent extends React.Component<INodeListComponentProps, { filter: string }> {
    ...
    private static _Tooltips: { [key: string]: string } = {
        ...
        SPSCreateBlock: "Create SPS with base mesh - outputs SolidParticleSystem",
        SPSInitParticleBlock: "Initialize updateParticle function for particle range (start-end)",
        SPSUpdatePositionBlock: "Update particle position",
        SPSUpdateRotationBlock: "Update particle rotation",
        SPSUpdateScalingBlock: "Update particle scaling",
        SPSUpdateColorBlock: "Update particle color",
        SPSUpdateVelocityBlock: "Update particle velocity",
        SPSPhysicsBlock: "Apply physics (gravity, damping, forces) to particle",
        SPSGetParticlePropertyBlock: "Get particle property (position, rotation, index, etc)",
