...
export class NodeListComponent extends React.Component<INodeListComponentProps, { filter: string }> {
    ...
    private static _Tooltips: { [key: string]: string } = {
        ...
        MeshSourceBlock: "Mesh source for SPS - load custom geometry from the inspector",
        NodeMaterialBlock: "Load a Node Material for SPS particles",
        InitSolidParticleBlock: "Configure solid particle: mesh, count, material, init/update",
        SolidParticleSystemBlock: "Configure Solid Particle System - connect SolidParticleSystemBlock output here",
        UpdateSolidParticleBlock: "Update solid particle - connect SolidParticleSystemBlock output here",
        CreateSolidParticleBlock: "Create Solid Particle System - outputs SolidParticleSystem",
        ...
        SolidParticleIndexBlock: "Contextual block to get the index of a solid particle",
