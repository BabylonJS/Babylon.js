...
export class NodeListComponent extends React.Component<INodeListComponentProps, { filter: string }> {
    ...
    private static _Tooltips: { [key: string]: string } = {
        ...
        SPSUpdateBlock: "Update SPS particles - connect SPSCreateBlock output here",
        SPSCreateBlock: "Create SPS with base mesh - outputs SolidParticleSystem",
        SPSInitBlock: "Initialize particles with configurable range and values (position, velocity, color, etc.)",
    ...
    override render() {
        ...
        const allBlocks: any = {
            ...
            SPS_Nodes: ["SPSMeshSourceBlock", "SPSSystemBlock", "SPSCreateBlock", "SPSInitBlock", "SPSUpdateBlock"],
            Contextual: [
                "PositionBlock",
                "DirectionBlock",
