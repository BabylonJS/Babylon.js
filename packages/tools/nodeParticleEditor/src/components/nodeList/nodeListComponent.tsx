...
export class NodeListComponent extends React.Component<INodeListComponentProps, { filter: string }> {
    ...
    private static _Tooltips: { [key: string]: string } = {
        ...
        CylinderEmitterBlock: "Emit particles from a cylinder shape",
        ...
        EmitterBlock: "Contextual block to get the coordinates of the emitter",
    ...
    override render() {
        ...
        const allBlocks: any = {
            ...
            Emitters: ["BoxEmitterBlock", "SphereEmitterBlock", "PointEmitterBlock", "CustomEmitterBlock", "CylinderEmitterBlock"],
            ...
            System_Nodes: ["SystemBlock", "TimeBlock", "DeltaBlock", "EmitterBlock"],
            Contextual: [
                "PositionBlock",
                "DirectionBlock",
