...
export class NodeListComponent extends React.Component<INodeListComponentProps, { filter: string }> {
    ...
    private static _Tooltips: { [key: string]: string } = {
        ...
        SPSNodeMaterialBlock: "Load a Node Material for SPS particles",
        ...
        SpsParticlePropsSetBlock: "Store a value into particle.props",
        SpsParticlePropsGetBlock: "Read a value from particle.props",
