...
import type { NodeLink } from "shared-ui-components/nodeGraphSystem/nodeLink";
...
export const StateBehaviorViewComponent: FC = () => {
    ...
    useEffect(() => {
        if (stateManager && graphCanvasComponent && selectedNode) {
            ...
            // Create nodes
            const nodesToAdd = [
                { name: "START", inputs: "in", output: "out", color: "green" },
                { name: "READY", inputs: "in", output: "out", color: "red" },
            ];
