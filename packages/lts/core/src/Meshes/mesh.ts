...
declare module "core/Meshes/mesh" {
    ...
    namespace Mesh {
         ...
         * * You can build other polyhedron types than the 15 embedded ones by setting the parameter `custom` (`polyhedronObject`, default null). If you set the parameter `custom`, this overwrites the parameter `type`
