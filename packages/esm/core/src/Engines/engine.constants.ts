...
export const enum Constants {
    ...
    TEXTURE_CUBE_MAP_ARRAY = 0xdeadbeef,
    /** 3D Texture target */
    TEXTURE_3D = 32879,
    ...
    GL_ALPHA_EQUATION_ADD = 0x8006,
    /** Alpha equation: MIN */
    GL_ALPHA_EQUATION_MIN = 0x8007,
    /** Alpha equation: MAX */
    GL_ALPHA_EQUATION_MAX = 0x8008,
    /** Alpha equation: SUBTRACT */
    GL_ALPHA_EQUATION_SUBTRACT = 0x800a,
    /** Alpha equation: REVERSE_SUBTRACT */
    GL_ALPHA_EQUATION_REVERSE_SUBTRACT = 0x800b,

    /** Alpha blend function: SRC */
    GL_ALPHA_FUNCTION_SRC = 0x0300,
    /** Alpha blend function: ONE_MINUS_SRC */
    GL_ALPHA_FUNCTION_ONE_MINUS_SRC_COLOR = 0x0301,
    /** Alpha blend function: SRC_ALPHA */
    GL_ALPHA_FUNCTION_SRC_ALPHA = 0x0302,
    /** Alpha blend function: ONE_MINUS_SRC_ALPHA */
    GL_ALPHA_FUNCTION_ONE_MINUS_SRC_ALPHA = 0x0303,
    /** Alpha blend function: DST_ALPHA */
    GL_ALPHA_FUNCTION_DST_ALPHA = 0x0304,
    /** Alpha blend function: ONE_MINUS_DST_ALPHA */
    GL_ALPHA_FUNCTION_ONE_MINUS_DST_ALPHA = 0x0305,
    /** Alpha blend function: ONE_MINUS_DST */
    GL_ALPHA_FUNCTION_DST_COLOR = 0x0306,
    /** Alpha blend function: ONE_MINUS_DST */
    GL_ALPHA_FUNCTION_ONE_MINUS_DST_COLOR = 0x0307,
    /** Alpha blend function: SRC_ALPHA_SATURATED */
    GL_ALPHA_FUNCTION_SRC_ALPHA_SATURATED = 0x0308,
    /** Alpha blend function: CONSTANT */
    GL_ALPHA_FUNCTION_CONSTANT_COLOR = 0x8001,
    /** Alpha blend function: ONE_MINUS_CONSTANT */
    GL_ALPHA_FUNCTION_ONE_MINUS_CONSTANT_COLOR = 0x8002,
    /** Alpha blend function: CONSTANT_ALPHA */
    GL_ALPHA_FUNCTION_CONSTANT_ALPHA = 0x8003,
    /** Alpha blend function: ONE_MINUS_CONSTANT_ALPHA */
    GL_ALPHA_FUNCTION_ONE_MINUS_CONSTANT_ALPHA = 0x8004,
