...
import { _setupMobileChecks, _sharedInit, initBaseEngineState } from "./engine.base.js";
...
export function _initGLContext(): void {
...
export function initAsync(engineState: IWebGPUEnginePublic, glslangOptions?: GlslangOptions, twgslOptions?: TwgslOptions): Promise<void> {
    ...
    return _initGlslang(glslangOptions ?? fes._options?.glslangOptions)
        .then(
            (glslang: any) => {
