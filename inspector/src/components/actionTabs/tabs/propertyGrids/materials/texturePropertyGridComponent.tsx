        ...
        return (
            <div className="pane">
                ...
                <LineContainerComponent title="GENERAL">
                    ...
                    <SliderLineComponent label="Level" target={texture} propertyName="level" minimum={0} maximum={10} step={0.01} onPropertyChangedObservable={this.props.onPropertyChangedObservable} />
                    {
