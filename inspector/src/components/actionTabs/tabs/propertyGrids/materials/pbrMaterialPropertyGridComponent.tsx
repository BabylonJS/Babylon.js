    ...
    renderTextures(onDebugSelectionChangeObservable: Observable<TextureLinkLineComponent>) {
        ...
        return (
            <LineContainerComponent title="CHANNELS" selection={this.props.globalState}>
                ...
                <TextureLinkLineComponent label="BakedVertexAnimationMap" texture={material.bakedVertexAnimationMap.texture} material={material} onTextureCreated={(texture) => material.bakedVertexAnimationMap.texture = texture} onTextureRemoved={() => material.bakedVertexAnimationMap.texture = null} onSelectionChangedObservable={this.props.onSelectionChangedObservable} onDebugSelectionChangeObservable={onDebugSelectionChangeObservable} />
                ...
                <CheckBoxLineComponent label="Use baked vertex animation map" target={material.bakedVertexAnimationMap} propertyName="isEnabled" onPropertyChangedObservable={this.props.onPropertyChangedObservable} />
        ...
        return (
            <div className="pane">
                ...
                <LineContainerComponent title="METALLIC WORKFLOW" selection={this.props.globalState}>
                    ...
                    <SliderLineComponent label="Index of Refraction" target={material} propertyName="indexOfRefraction" minimum={1} maximum={3} step={0.01} onPropertyChangedObservable={this.props.onPropertyChangedObservable} />
                    ...
                    <CheckBoxLineComponent label="Use only metallic from MetallicReflectance texture" target={material} propertyName="useOnlyMetallicFromMetallicReflectanceTexture" onPropertyChangedObservable={this.props.onPropertyChangedObservable} />
                    <TextureLinkLineComponent label="MetallicReflectance Texture" texture={material.metallicReflectanceTexture} onTextureCreated={(texture) => material.metallicReflectanceTexture = texture} onTextureRemoved={() => material.metallicReflectanceTexture = null} material={material} onSelectionChangedObservable={this.props.onSelectionChangedObservable} onDebugSelectionChangeObservable={this._onDebugSelectionChangeObservable} />
                    <TextureLinkLineComponent label="Reflectance Texture" texture={material.reflectanceTexture} onTextureCreated={(texture) => material.reflectanceTexture = texture} onTextureRemoved={() => material.reflectanceTexture = null} material={material} onSelectionChangedObservable={this.props.onSelectionChangedObservable} onDebugSelectionChangeObservable={this._onDebugSelectionChangeObservable} />
                </LineContainerComponent>
