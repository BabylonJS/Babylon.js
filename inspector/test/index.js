...
var Test = (function () {
    ...
    Test.prototype._initScene = function () {
        ...
        let DDSTexture2 = new BABYLON.Texture("test/L.dds", scene);

        let JPGTexture = new BABYLON.Texture("test/textureTestJPG.jpg", scene);
        let PNGTexture = new BABYLON.Texture("test/decoded_dxt1_image.png", scene);
