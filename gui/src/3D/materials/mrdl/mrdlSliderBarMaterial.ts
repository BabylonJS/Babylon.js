...
export class MRDLSliderBarMaterial extends PushMaterial {
    ...
    public isReadyForSubMesh(mesh: AbstractMesh, subMesh: SubMesh, useInstances?: boolean): boolean {
        ...
        const defines = <MRDLSliderBarMaterialDefines>subMesh._materialDefines;
    ...
    public bindForSubMesh(world: Matrix, mesh: Mesh, subMesh: SubMesh): void {
        ...
        // "Round Rect"
        this._activeEffect.setFloat("_Radius_", 0.5);
        this._activeEffect.setFloat("_Bevel_Front_", 0.429);
...
_TypeStore.RegisteredTypes["BABYLON.GUI.MRDLSliderBarMaterial"] = MRDLSliderBarMaterial;
