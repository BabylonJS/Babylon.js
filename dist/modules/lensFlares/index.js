...
BABYLON.Effect.ShadersStore['lensFlareVertexShader'] = "\nattribute vec2 position;\n\nuniform mat4 viewportMatrix;\n\nvarying vec2 vUV;\nconst vec2 madd=vec2(0.5,0.5);\nvoid main(void) { \nvUV=position*madd+madd;\ngl_Position=viewportMatrix*vec4(position,0.0,1.0);\n}";
BABYLON.Effect.ShadersStore['lensFlarePixelShader'] = "\nvarying vec2 vUV;\nuniform sampler2D textureSampler;\n\nuniform vec4 color;\nvoid main(void) {\nvec4 baseColor=texture2D(textureSampler,vUV);\ngl_FragColor=baseColor*color;\n}";
...
(function() {
var EXPORTS = {};EXPORTS['LensFlare'] = BABYLON['LensFlare'];EXPORTS['LensFlareSystem'] = BABYLON['LensFlareSystem'];
