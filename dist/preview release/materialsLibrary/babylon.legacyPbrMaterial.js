        ...
        LegacyPBRMaterial.prototype.bind = function (world, mesh) {
            ...
            if (this._myScene.getCachedMaterial() !== this || !this.isFrozen) {
                ...
                if (this._myScene.lightsEnabled && !this.disableLighting) {
                    BABYLON.PBRMaterial.BindLights(this._myScene, mesh, this._effect, this._defines, this.useScalarInLinearSpace, this.maxSimultaneousLights, this.usePhysicalLightFalloff);
                }
                // View
