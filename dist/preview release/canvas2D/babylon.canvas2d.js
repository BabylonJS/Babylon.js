...
(function (BABYLON) {
    ...
    var AtlasPictureInfoFactory = (function () {
         ...
         */
        AtlasPictureInfoFactory.loadFromUrl = function (texture, url, loaded, error) {
        ...
        AtlasPictureInfoFactory._initialize = function () {
    ...
    AtlasPictureInfoFactory.plugins = null;
