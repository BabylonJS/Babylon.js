declare module BABYLON {
    ...
    class Engine {
        ...
        bindFramebuffer(texture: WebGLTexture, faceIndex?: number, requiredWidth?: number, requiredHeight?: number, forceFullscreenViewport?: boolean): void;
...
declare module BABYLON {
    ...
    class Effect {
        ...
        private _prepareEffect(vertexSourceCode, fragmentSourceCode, attributesNames, defines, fallbacks?, baseName?);
...
declare module BABYLON {
    class AbstractMesh extends Node implements IDisposable, ICullable, IGetSetVerticesData {
        ...
        static OCCLUSION_TYPE_NO_VALUE: number;
        ...
        */
        ...
        position: Vector3;
        private _occlusionBoundingBoxRenderer;
        private _gl;
        private _webGLVersion;
        ...
        isOccluded: boolean;
        occlusionQuery: WebGLQuery;
        isOcclusionQueryInProgress: boolean;
        private _occlusionQueryAlgorithmType;
...
declare module BABYLON {
    class OcclusionBoundingBoxRenderer {
        private _scene;
        private _colorShader;
        private _vertexBuffers;
        private _indexBuffer;
