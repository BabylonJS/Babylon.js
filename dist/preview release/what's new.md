...
- Fixed issue with DeviceSourceManager where gamepads that were already connected when a script was started weren't being registered ([PolygonalSun](https://github.com/PolygonalSun))
