...
-   If user clicks on "New Key" button on ACE and a key already exists at that frame, update the key value instead of creating a new one. ([carolhmj](https://github.com/carolhmj))
