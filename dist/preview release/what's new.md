...
- Added [support for AmmoJS](https://doc.babylonjs.com/how_to/using_the_physics_engine) as a physics plugin (Composite objects, motors, joints) ([TrevorDev](https://github.com/TrevorDev))
  ...
  - Added getShaderName to PBRMaterialBase to allow subclasses to specify custom shaders [MackeyK24](https://github.com/mackeyk24))
  - Added getShaderName to StandardMaterial to allow subclasses to specify custom shaders [MackeyK24](https://github.com/mackeyk24))
  - Added customShaderNameResolve to PBRMaterialBase to allow consistent shadre name resolve for custom shaders [MackeyK24](https://github.com/mackeyk24))
