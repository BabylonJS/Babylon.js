declare module "babylonjs-inspector/2D/valueAndUnit" {
    import { AdvancedDynamicTexture } from "babylonjs-inspector/2D/advancedDynamicTexture";
    /**
...
declare module "babylonjs-inspector/2D/style" {
    import { Observable } from "babylonjs/Misc/observable";
    import { IDisposable } from "babylonjs/scene";
    import { AdvancedDynamicTexture } from "babylonjs-inspector/2D/advancedDynamicTexture";
    import { ValueAndUnit } from "babylonjs-inspector/2D/valueAndUnit";
    /**
...
declare module "babylonjs-inspector/2D/math2D" {
...
declare module "babylonjs-inspector/2D/measure" {
    import { Matrix2D } from "babylonjs-inspector/2D/math2D";
    /**
...
declare module "babylonjs-inspector/2D/advancedDynamicTexture" {
    import { Nullable } from "babylonjs/types";
    import { Observable } from "babylonjs/Misc/observable";
    ...
    import { Container } from "babylonjs-inspector/2D/controls/container";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { Style } from "babylonjs-inspector/2D/style";
    /**
...
declare module "babylonjs-inspector/2D/controls/control" {
    import { Nullable } from "babylonjs/types";
    import { Observable } from "babylonjs/Misc/observable";
    ...
    import { AdvancedDynamicTexture } from "babylonjs-inspector/2D/advancedDynamicTexture";
    import { ValueAndUnit } from "babylonjs-inspector/2D/valueAndUnit";
    import { Measure } from "babylonjs-inspector/2D/measure";
    import { Style } from "babylonjs-inspector/2D/style";
    import { Matrix2D, Vector2WithInfo } from "babylonjs-inspector/2D/math2D";
    /**
...
declare module "babylonjs-inspector/2D/controls/container" {
    import { Nullable } from "babylonjs/types";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { Measure } from "babylonjs-inspector/2D/measure";
    import { AdvancedDynamicTexture } from "babylonjs-inspector/2D/advancedDynamicTexture";
...
declare module "babylonjs-inspector/2D/controls/rectangle" {
    import { Container } from "babylonjs-inspector/2D/controls/container";
    import { Measure } from "babylonjs-inspector/2D/measure";
...
declare module "babylonjs-inspector/2D/controls/textBlock" {
    import { Observable } from "babylonjs/Misc/observable";
    import { Measure } from "babylonjs-inspector/2D/measure";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { Nullable } from 'babylonjs/types';
...
declare module "babylonjs-inspector/2D/controls/image" {
    import { Nullable } from "babylonjs/types";
    import { Observable } from "babylonjs/Misc/observable";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { Measure } from "babylonjs-inspector/2D/measure";
...
declare module "babylonjs-inspector/2D/controls/button" {
    import { Nullable } from "babylonjs/types";
    import { Vector2 } from "babylonjs/Maths/math";
    import { Rectangle } from "babylonjs-inspector/2D/controls/rectangle";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { TextBlock } from "babylonjs-inspector/2D/controls/textBlock";
    import { Image } from "babylonjs-inspector/2D/controls/image";
    /**
...
declare module "babylonjs-inspector/2D/controls/stackPanel" {
    import { Container } from "babylonjs-inspector/2D/controls/container";
    import { Measure } from "babylonjs-inspector/2D/measure";
    /**
...
declare module "babylonjs-inspector/2D/controls/checkbox" {
    import { Observable } from "babylonjs/Misc/observable";
    import { Vector2 } from "babylonjs/Maths/math";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { StackPanel } from "babylonjs-inspector/2D/controls/stackPanel";
    import { Nullable } from 'babylonjs/types';
    import { Measure } from "babylonjs-inspector/2D/measure";
    /**
...
declare module "babylonjs-inspector/2D/controls/virtualKeyboard" {
    import { Nullable } from "babylonjs/types";
    import { Observable } from "babylonjs/Misc/observable";
    import { StackPanel } from "babylonjs-inspector/2D/controls/stackPanel";
    import { InputText } from "babylonjs-inspector/2D/controls/inputText";
    /**
...
declare module "babylonjs-inspector/2D/controls/inputText" {
    import { Nullable } from "babylonjs/types";
    import { Observable } from "babylonjs/Misc/observable";
    import { Vector2 } from "babylonjs/Maths/math";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { IFocusableControl } from "babylonjs-inspector/2D/advancedDynamicTexture";
    import { VirtualKeyboard } from "babylonjs-inspector/2D/controls/virtualKeyboard";
    import { Measure } from "babylonjs-inspector/2D/measure";
    /**
...
declare module "babylonjs-inspector/2D/controls/grid" {
    import { Nullable } from "babylonjs/types";
    import { Container } from "babylonjs-inspector/2D/controls/container";
    import { ValueAndUnit } from "babylonjs-inspector/2D/valueAndUnit";
    import { Control } from "babylonjs-inspector/2D/controls/control";
...
declare module "babylonjs-inspector/2D/controls/colorpicker" {
    import { Observable } from "babylonjs/Misc/observable";
...
declare module "babylonjs-inspector/2D/controls/ellipse" {
    import { Container } from "babylonjs-inspector/2D/controls/container";
    import { Measure } from "babylonjs-inspector/2D/measure";
...
declare module "babylonjs-inspector/2D/controls/inputPassword" {
    import { InputText } from "babylonjs-inspector/2D/controls/inputText";
    /**
...
declare module "babylonjs-inspector/2D/controls/line" {
...
declare module "babylonjs-inspector/2D/multiLinePoint" {
    import { Nullable } from "babylonjs/types";
    import { Vector2 } from "babylonjs/Maths/math";
    import { AbstractMesh } from "babylonjs/Meshes/abstractMesh";
    import { MultiLine } from "babylonjs-inspector/2D/controls/multiLine";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    /**
...
declare module "babylonjs-inspector/2D/controls/multiLine" {
    import { Nullable } from "babylonjs/types";
    import { AbstractMesh } from "babylonjs/Meshes/abstractMesh";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { MultiLinePoint } from "babylonjs-inspector/2D/multiLinePoint";
    import { Measure } from "babylonjs-inspector/2D/measure";
    /**
...
declare module "babylonjs-inspector/2D/controls/radioButton" {
    import { Observable } from "babylonjs/Misc/observable";
    import { Vector2 } from "babylonjs/Maths/math";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { StackPanel } from "babylonjs-inspector/2D/controls/stackPanel";
...
declare module "babylonjs-inspector/2D/controls/sliders/baseSlider" {
    import { Observable } from "babylonjs/Misc/observable";
    import { Vector2 } from "babylonjs/Maths/math";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { ValueAndUnit } from "babylonjs-inspector/2D/valueAndUnit";
...
declare module "babylonjs-inspector/2D/controls/sliders/slider" {
    import { BaseSlider } from "babylonjs-inspector/2D/controls/sliders/baseSlider";
    import { Nullable } from 'babylonjs/types';
    import { Measure } from "babylonjs-inspector/2D/measure";
    /**
     * Class used to create slider controls
...
declare module "babylonjs-inspector/2D/controls/selector" {
    import { Rectangle } from "babylonjs-inspector/2D/controls/rectangle";
    import { StackPanel } from "babylonjs-inspector/2D/controls/stackPanel";
...
declare module "babylonjs-inspector/2D/controls/scrollViewers/scrollViewerWindow" {
    import { Measure } from "babylonjs-inspector/2D/measure";
    import { Container } from "babylonjs-inspector/2D/controls/container";
    /**
...
declare module "babylonjs-inspector/2D/controls/sliders/scrollBar" {
    import { Vector2 } from "babylonjs/Maths/math";
    import { BaseSlider } from "babylonjs-inspector/2D/controls/sliders/baseSlider";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    /**
...
declare module "babylonjs-inspector/2D/controls/sliders/imageScrollBar" {
    import { Vector2 } from "babylonjs/Maths/math";
    import { BaseSlider } from "babylonjs-inspector/2D/controls/sliders/baseSlider";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { Image } from "babylonjs-inspector/2D/controls/image";
...
declare module "babylonjs-inspector/2D/controls/scrollViewers/scrollViewer" {
    import { Nullable } from "babylonjs/types";
    import { Rectangle } from "babylonjs-inspector/2D/controls/rectangle";
    import { Image } from "babylonjs-inspector/2D/controls/image";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    ...
    import { Measure } from "babylonjs-inspector/2D/measure";
    import { AdvancedDynamicTexture } from "babylonjs-inspector/2D/advancedDynamicTexture";
    import { ScrollBar } from "babylonjs-inspector/2D/controls/sliders/scrollBar";
    import { ImageScrollBar } from "babylonjs-inspector/2D/controls/sliders/imageScrollBar";
    /**
...
declare module "babylonjs-inspector/2D/controls/displayGrid" {
    import { Control } from "babylonjs-inspector/2D/controls/control";
    import { Nullable } from 'babylonjs/types';
    import { Measure } from "babylonjs-inspector/2D/measure";
...
declare module "babylonjs-inspector/2D/controls/sliders/imageBasedSlider" {
    import { BaseSlider } from "babylonjs-inspector/2D/controls/sliders/baseSlider";
    import { Measure } from "babylonjs-inspector/2D/measure";
    import { Image } from "babylonjs-inspector/2D/controls/image";
    import { Nullable } from 'babylonjs/types';
...
declare module "babylonjs-inspector/2D/controls/statics" {
    /**
...
declare module "babylonjs-inspector/2D/controls/index" {
    export * from "babylonjs-inspector/2D/controls/button";
    export * from "babylonjs-inspector/2D/controls/checkbox";
    export * from "babylonjs-inspector/2D/controls/colorpicker";
    export * from "babylonjs-inspector/2D/controls/container";
    export * from "babylonjs-inspector/2D/controls/control";
    export * from "babylonjs-inspector/2D/controls/ellipse";
    export * from "babylonjs-inspector/2D/controls/grid";
    export * from "babylonjs-inspector/2D/controls/image";
    export * from "babylonjs-inspector/2D/controls/inputText";
    export * from "babylonjs-inspector/2D/controls/inputPassword";
    export * from "babylonjs-inspector/2D/controls/line";
    export * from "babylonjs-inspector/2D/controls/multiLine";
    export * from "babylonjs-inspector/2D/controls/radioButton";
    export * from "babylonjs-inspector/2D/controls/stackPanel";
    export * from "babylonjs-inspector/2D/controls/selector";
    export * from "babylonjs-inspector/2D/controls/scrollViewers/scrollViewer";
    export * from "babylonjs-inspector/2D/controls/textBlock";
    export * from "babylonjs-inspector/2D/controls/virtualKeyboard";
    export * from "babylonjs-inspector/2D/controls/rectangle";
    export * from "babylonjs-inspector/2D/controls/displayGrid";
    export * from "babylonjs-inspector/2D/controls/sliders/baseSlider";
    export * from "babylonjs-inspector/2D/controls/sliders/slider";
    export * from "babylonjs-inspector/2D/controls/sliders/imageBasedSlider";
    export * from "babylonjs-inspector/2D/controls/sliders/scrollBar";
    export * from "babylonjs-inspector/2D/controls/sliders/imageScrollBar";
    export * from "babylonjs-inspector/2D/controls/statics";
}
declare module "babylonjs-inspector/2D/adtInstrumentation" {
...
declare module "babylonjs-inspector/2D/xmlLoader" {
    /**
...
declare module "babylonjs-inspector/2D/index" {
    export * from "babylonjs-inspector/2D/controls/index";
    export * from "babylonjs-inspector/2D/advancedDynamicTexture";
    export * from "babylonjs-inspector/2D/adtInstrumentation";
    export * from "babylonjs-inspector/2D/math2D";
    export * from "babylonjs-inspector/2D/measure";
    export * from "babylonjs-inspector/2D/multiLinePoint";
    export * from "babylonjs-inspector/2D/style";
    export * from "babylonjs-inspector/2D/valueAndUnit";
    export * from "babylonjs-inspector/2D/xmlLoader";
}
declare module "babylonjs-inspector/3D/controls/container3D" {
    import { Nullable } from "babylonjs/types";
    import { TransformNode } from "babylonjs/Meshes/transformNode";
    import { Scene } from "babylonjs/scene";
    import { Control3D } from "babylonjs-inspector/3D/controls/control3D";
    /**
...
declare module "babylonjs-inspector/3D/gui3DManager" {
    import { Nullable } from "babylonjs/types";
    import { Observable } from "babylonjs/Misc/observable";
    import { Vector3 } from "babylonjs/Maths/math";
    ...
    import { Container3D } from "babylonjs-inspector/3D/controls/container3D";
    import { Control3D } from "babylonjs-inspector/3D/controls/control3D";
    /**
...
declare module "babylonjs-inspector/3D/vector3WithInfo" {
    import { Vector3 } from "babylonjs/Maths/math";
    /**
...
declare module "babylonjs-inspector/3D/controls/control3D" {
    import { Nullable } from "babylonjs/types";
    import { Observable } from "babylonjs/Misc/observable";
    import { Vector3 } from "babylonjs/Maths/math";
    import { TransformNode } from "babylonjs/Meshes/transformNode";
    ...
    import { IDisposable, Scene } from "babylonjs/scene";
    import { GUI3DManager } from "babylonjs-inspector/3D/gui3DManager";
    import { Vector3WithInfo } from "babylonjs-inspector/3D/vector3WithInfo";
    import { Container3D } from "babylonjs-inspector/3D/controls/container3D";
    /**
...
declare module "babylonjs-inspector/3D/controls/abstractButton3D" {
    import { TransformNode } from "babylonjs/Meshes/transformNode";
    import { Scene } from "babylonjs/scene";
    import { Control3D } from "babylonjs-inspector/3D/controls/control3D";
    /**
...
declare module "babylonjs-inspector/3D/controls/button3D" {
    import { int } from "babylonjs/types";
    import { TransformNode } from "babylonjs/Meshes/transformNode";
    import { AbstractMesh } from "babylonjs/Meshes/abstractMesh";
    import { Material } from "babylonjs/Materials/material";
    import { Scene } from "babylonjs/scene";
    import { AbstractButton3D } from "babylonjs-inspector/3D/controls/abstractButton3D";
    import { AdvancedDynamicTexture } from "babylonjs-inspector/2D/advancedDynamicTexture";
    import { Control } from "babylonjs-inspector/2D/controls/control";
    /**
...
declare module "babylonjs-inspector/3D/controls/volumeBasedPanel" {
...
declare module "babylonjs-inspector/3D/controls/cylinderPanel" {
    import { Vector3 } from "babylonjs/Maths/math.vector";
    import { float } from "babylonjs/types";
    import { VolumeBasedPanel } from "babylonjs-inspector/3D/controls/volumeBasedPanel";
    import { Control3D } from "babylonjs-inspector/3D/controls/control3D";
    /**
...
declare module "babylonjs-inspector/3D/materials/shaders/fluent.vertex" {
    /** @hidden */
...
declare module "babylonjs-inspector/3D/materials/shaders/fluent.fragment" {
    /** @hidden */
...
declare module "babylonjs-inspector/3D/materials/fluentMaterial" {
    import { Nullable } from "babylonjs/types";
    ...
    import { Scene } from "babylonjs/scene";
    import "babylonjs-inspector/3D/materials/shaders/fluent.vertex";
    import "babylonjs-inspector/3D/materials/shaders/fluent.fragment";
    /** @hidden */
...
declare module "babylonjs-inspector/3D/controls/holographicButton" {
    import { Button3D } from "babylonjs-inspector/3D/controls/button3D";
    import { Nullable } from "babylonjs/types";
    import { StandardMaterial } from "babylonjs/Materials/standardMaterial";
    import { TransformNode } from "babylonjs/Meshes/transformNode";
    import { Mesh } from "babylonjs/Meshes/mesh";
    import { Scene } from "babylonjs/scene";
    import { FluentMaterial } from "babylonjs-inspector/3D/materials/fluentMaterial";
    import { AdvancedDynamicTexture } from "babylonjs-inspector/2D/advancedDynamicTexture";
    /**
...
declare module "babylonjs-inspector/3D/controls/meshButton3D" {
    import { TransformNode } from "babylonjs/Meshes/transformNode";
    import { AbstractMesh } from "babylonjs/Meshes/abstractMesh";
    import { Mesh } from "babylonjs/Meshes/mesh";
    import { Scene } from "babylonjs/scene";
...
declare module "babylonjs-inspector/3D/controls/planePanel" {
    import { Vector3 } from "babylonjs/Maths/math";
    import { Control3D } from "babylonjs-inspector/3D/controls/control3D";
    import { VolumeBasedPanel } from "babylonjs-inspector/3D/controls/volumeBasedPanel";
    /**
...
declare module "babylonjs-inspector/3D/controls/scatterPanel" {
    import { Vector3 } from "babylonjs/Maths/math";
    import { float } from "babylonjs/types";
    import { VolumeBasedPanel } from "babylonjs-inspector/3D/controls/volumeBasedPanel";
    import { Control3D } from "babylonjs-inspector/3D/controls/control3D";
...
declare module "babylonjs-inspector/3D/controls/spherePanel" {
    import { Vector3 } from "babylonjs/Maths/math";
    import { float } from "babylonjs/types";
    import { VolumeBasedPanel } from "babylonjs-inspector/3D/controls/volumeBasedPanel";
    import { Control3D } from "babylonjs-inspector/3D/controls/control3D";
...
declare module "babylonjs-inspector/3D/controls/stackPanel3D" {
    import { Container3D } from "babylonjs-inspector/3D/controls/container3D";
    /**
...
declare module "babylonjs-inspector/3D/controls/index" {
    export * from "babylonjs-inspector/3D/controls/abstractButton3D";
    export * from "babylonjs-inspector/3D/controls/button3D";
    export * from "babylonjs-inspector/3D/controls/container3D";
    export * from "babylonjs-inspector/3D/controls/control3D";
    export * from "babylonjs-inspector/3D/controls/cylinderPanel";
    export * from "babylonjs-inspector/3D/controls/holographicButton";
    export * from "babylonjs-inspector/3D/controls/meshButton3D";
    export * from "babylonjs-inspector/3D/controls/planePanel";
    export * from "babylonjs-inspector/3D/controls/scatterPanel";
    export * from "babylonjs-inspector/3D/controls/spherePanel";
    export * from "babylonjs-inspector/3D/controls/stackPanel3D";
    export * from "babylonjs-inspector/3D/controls/volumeBasedPanel";
}
declare module "babylonjs-inspector/3D/materials/index" {
    export * from "babylonjs-inspector/3D/materials/fluentMaterial";
}
declare module "babylonjs-inspector/3D/index" {
    export * from "babylonjs-inspector/3D/controls/index";
    export * from "babylonjs-inspector/3D/materials/index";
    export * from "babylonjs-inspector/3D/gui3DManager";
    export * from "babylonjs-inspector/3D/vector3WithInfo";
}
declare module "babylonjs-inspector/index" {
    export * from "babylonjs-inspector/2D/index";
    export * from "babylonjs-inspector/3D/index";
}
