...
BABYLON.Effect.ShadersStore['proceduralVertexShader'] = "\nattribute vec2 position;\n\nvarying vec2 vPosition;\nvarying vec2 vUV;\nconst vec2 madd=vec2(0.5,0.5);\nvoid main(void) { \nvPosition=position;\nvUV=position*madd+madd;\ngl_Position=vec4(position,0.0,1.0);\n}";
...
var ProceduralTexture = BABYLON.ProceduralTexture;
var CustomProceduralTexture = BABYLON.CustomProceduralTexture;

export { ProceduralTexture,CustomProceduralTexture };