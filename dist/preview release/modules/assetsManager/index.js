...
(function() {
var EXPORTS = {};EXPORTS['AssetTaskState'] = BABYLON['AssetTaskState'];EXPORTS['AbstractAssetTask'] = BABYLON['AbstractAssetTask'];EXPORTS['AssetsProgressEvent'] = BABYLON['AssetsProgressEvent'];EXPORTS['MeshAssetTask'] = BABYLON['MeshAssetTask'];EXPORTS['TextFileAssetTask'] = BABYLON['TextFileAssetTask'];EXPORTS['BinaryFileAssetTask'] = BABYLON['BinaryFileAssetTask'];EXPORTS['ImageAssetTask'] = BABYLON['ImageAssetTask'];EXPORTS['TextureAssetTask'] = BABYLON['TextureAssetTask'];EXPORTS['CubeTextureAssetTask'] = BABYLON['CubeTextureAssetTask'];EXPORTS['HDRCubeTextureAssetTask'] = BABYLON['HDRCubeTextureAssetTask'];EXPORTS['AssetsManager'] = BABYLON['AssetsManager'];
