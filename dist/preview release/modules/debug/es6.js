...
import * as shaderMaterial from 'babylonjs/shaderMaterial/es6';
import * as additionalMeshes from 'babylonjs/additionalMeshes/es6';
__extends(BABYLON, additionalMeshes);
import * as BABYLON from 'babylonjs/core/es6';
__extends(BABYLON, core);
import * as stringDictionary from 'babylonjs/stringDictionary/es6';
__extends(BABYLON, stringDictionary);
import * as actions from 'babylonjs/actions/es6';
__extends(BABYLON, actions);
...
var Debug = BABYLON.Debug;
var RayHelper = BABYLON.RayHelper;
var DebugLayer = BABYLON.DebugLayer;
var BoundingBoxRenderer = BABYLON.BoundingBoxRenderer;

export { Debug,RayHelper,DebugLayer,BoundingBoxRenderer };