declare module BABYLON {
    ...
    class Engine {
        ...
        createEffect(baseName: any, attributesNames: string[], uniformsNames: string[], uniformBuffers: string[], samplers: string[], defines: string, fallbacks?: EffectFallbacks, onCompiled?: (effect: Effect) => void, onError?: (effect: Effect, errors: string) => void, indexParameters?: any): Effect;
...
declare module BABYLON {
    ...
    class Scene implements IAnimatable {
        ...
        */
        ...
        private _transformMatrixBuffer;
        ...
        */
        ...
        getTransformMatrixBuffer(): UniformBuffer;
        getUniqueId(): number;
...
declare module BABYLON {
    class DirectionalLight extends Light implements IShadowLight {
         ...
         * Returns the DirectionalLight.
         */
        transferToEffect(effect: Effect): DirectionalLight;
...
declare module BABYLON {
    class HemisphericLight extends Light {
         ...
         */
        transferToEffect(effect: Effect): HemisphericLight;
        _getWorldMatrix(): Matrix;
        /**
...
declare module BABYLON {
    class PointLight extends Light implements IShadowLight {
         ...
         */
        transferToEffect(effect: Effect): PointLight;
        /**
...
declare module BABYLON {
    class SpotLight extends Light implements IShadowLight {
         ...
         */
        transferToEffect(effect: Effect): SpotLight;
        _getWorldMatrix(): Matrix;
        /**
...
declare module BABYLON {
    ...
    class Effect {
        ...
        private _program;
        private _valueCache;
        constructor(baseName: any, attributesNames: string[], uniformsNames: string[], uniformBuffers: string[], samplers: string[], engine: any, defines?: string, fallbacks?: EffectFallbacks, onCompiled?: (effect: Effect) => void, onError?: (effect: Effect, errors: string) => void, indexParameters?: any);
        readonly key: string;
        isReady(): boolean;
...
declare module BABYLON {
    class MaterialHelper {
        ...
        static PrepareUniformsAndSamplersList(uniformsList: string[], uniformBuffersList: string[], samplersList: string[], defines: MaterialDefines, maxSimultaneousLights?: number): void;
...
declare module BABYLON {
    class PushMaterial extends Material {
        ...
        getEffect(): Effect;
        isReady(mesh?: AbstractMesh, useInstances?: boolean): boolean;
        bindTransformMatrix(effect: Effect, transformMatrixBuffer: UniformBuffer): void;
        bindOnlyWorldMatrix(world: Matrix): void;
        bind(world: Matrix, mesh?: Mesh): void;
