...
declare module BABYLON {
    class BoundingBox implements ICullable {
        ...
        static Intersects(box0: BoundingBox, box1: BoundingBox, isStrict?: boolean): boolean;
...
declare module BABYLON {
    ...
    class BoundingInfo implements ICullable {
        ...
        intersectsPoint(point: Vector3): boolean;
        intersects(boundingInfo: BoundingInfo, precise: boolean, isStrict?: boolean): boolean;
    }
}
...
declare module BABYLON {
    class BoundingSphere {
        ...
        isInFrustum(frustumPlanes: Plane[]): boolean;
        intersectsPoint(point: Vector3): boolean;
        static Intersects(sphere0: BoundingSphere, sphere1: BoundingSphere, isStrict?: boolean): boolean;
    }
}
...
declare module BABYLON {
    class AbstractMesh extends Node implements IDisposable, ICullable {
        ...
        */
        ...
        isInFrustum(frustumPlanes: Plane[]): boolean;
        isCompletelyInFrustum(frustumPlanes: Plane[]): boolean;
        intersectsMesh(mesh: AbstractMesh | SolidParticle, precise?: boolean, isStrict?: boolean): boolean;
        intersectsPoint(point: Vector3): boolean;
        /**
