...
declare module BABYLON {
    ...
    /**
     * The highlight layer adds a colored glow effect around a mesh.
     *
    ...
    class HighlightLayer {
        ...
        /**
         * Instantiates a new highlight layer and attaches it to the specified scene.
         * @param name The name of the layer
         * @param scene The scene to use the layer in
         * @param options Options to use with the layer (see [[IHighlightLayerOptions]] for more information)
         */
        ...
        /**
         * Removes a mesh from the highlight layer in order to make it stop glowing.
         * @param mesh The mesh to stop highlighting
         */
        ...
        /**
         * Forces the stencil to the normal expected value for none glowing parts
         */
