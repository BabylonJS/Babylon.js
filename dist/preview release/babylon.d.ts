declare module BABYLON {
    ...
    class Engine {
        ...
        createRawCubeTexture: (url: string, scene: Scene, size: number, format: number, type: number, noMipmap: boolean, callback: (ArrayBuffer: any) => ArrayBufferView[]) => WebGLTexture;
