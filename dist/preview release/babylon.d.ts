...
declare module BABYLON {
    class UniformBuffer {
         ...
         */
        updateFloat3(name: string, x: number, y: number, z: number, suffix?: string | number): void;
        /**
         * Wrapper for updateUniform.
         * @param {string} name Name of the uniform, as used in the uniform block in the shader.
         * @param {number} x
         ...
         * @param {string|number} [suffix] Suffix to add to the uniform name.
         */
        updateFloat4(name: string, x: number, y: number, z: number, w: number, suffix?: string | number): void;
        /**
         * Wrapper for updateUniform.
         * @param {string} name Name of the uniform, as used in the uniform block in the shader.
         ...
         * @param {string|number} [suffix] Suffix to add to the uniform name.
         */
        updateColor3(name: string, color: Color3, suffix?: string | number): void;
        /**
         * Wrapper for updateUniform.
         * @param {string} name Name of the uniform, as used in the uniform block in the shader.
         * @param {Color3} color
         ...
         * @param {string|number} [suffix] Suffix to add to the uniform name.
         */
        updateColor4(name: string, color: Color3, alpha: number, suffix?: string | number): void;
        /**
