...
declare module BABYLON {
    ...
    class Scene implements IAnimatable {
        ...
        */
        ...
        quadframeRenderers: QuadframeRenderer[];
...
declare module BABYLON {
    class QuadframeRenderer {
        ...
        render(): void;
        private _disposeFrame(frame);
        dispose(): void;
        private _checkInclusion(sourceIndices, childIndices, positions);
        private _pumpPositions(positions, index, target);
        private _generateQuadLines(frame);
    }
}
...
declare module BABYLON {
    class RenderingGroup {
         ...
         */
        render(customRenderFunction: (opaqueSubMeshes: SmartArray<SubMesh>, transparentSubMeshes: SmartArray<SubMesh>, alphaTestSubMeshes: SmartArray<SubMesh>) => void): void;
        /**
