...
declare module BABYLON {
    ...
    class Effect {
        ...
        private _uniformBufferPerPass;
        private _uniformBufferPerScene;
        private _samplers;
        private _isReady;
        ...
        setUniformBufferScene(cameraPositionFormatted: Float32Array): Effect;
        setUniformBufferPass(materialFormatted: Float32Array): Effect;
...
declare module BABYLON {
    ...
    class WebVRFreeCamera extends FreeCamera implements PoseControlled {
         ...
         */
        protected _getWebVRViewMatrix(): Matrix;
        _updateWebVRCameraRotationMatrix(): void;
        _isSynchronizedViewMatrix(): boolean;
        protected _getWebVRProjectionMatrix(): Matrix;
