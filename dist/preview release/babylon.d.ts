declare module BABYLON {
    ...
    class Engine {
         ...
         */
        static MarkAllMaterialsAsDirty(): void;
...
declare module BABYLON {
    class AbstractMesh extends Node implements IDisposable, ICullable {
        ...
        */
        ...
        _unIndexed: boolean;
        _poseMatrix: Matrix;
        _lightSources: SmartArray<Light>;
        _waitingActions: any;
...
declare module BABYLON {
    class ObservableArray<T> {
        data: Array<T>;
        length: number;
        onDataAdded: Observable<T>;
        onDataRemoved: Observable<T>;
        constructor();
